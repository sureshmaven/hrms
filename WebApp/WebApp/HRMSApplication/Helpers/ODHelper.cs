        ...
        public string SendEmails(DateTime StartDate, DateTime EnDate, int lControllingId, int lSancationingId, int lempId, int lVistorFrom, string VistorTo,int Purpose, string Description, string Status, string AppliedValue)
        {
            ...
            try
            {
                ...
                if (Status == "Leave" && AppliedValue == "0")
                {
                    ...
                    lb.Append("<p>&nbsp;</p>");
                    lb.Append("<p>&nbsp;</p>");
                    lb.Append("<p>************ This mail is Generated from 'TGCAB-HRMS' ************</p>");
        ...
        public string SendSms1(DateTime StartDate, DateTime EnDate, int lControllingId, int lSancationingId, int lempId, int lVistorFrom, string VistorTo, int Purpose, string Status, string AppliedValue)
        {
            ...
            try
            {
                ...
                if (Status == "HRMSOD" && AppliedValue == "0")
                {
                    ...
                    string lcontent = "Leave Request sent from " + lEmployeeFullName + " " + (lEmpCode) + " Starting from " + lStartDate + " to " + lEnDate + "  Visting From " + lVistingFrom + " to " + VistorTo + " Purpose " + lPurpose + "     Thank you TGCAB-HRMS ";
                ...
                {
                    // Emp, Sancationing
                    string lcontent = "OD Request Approved for  " + lEmployeeFullName + " " + (lEmpCode) + " Starting from " + lStartDate + " to " + lEnDate + "Visting From:" + lVistingFrom + "to " + VistorTo + "Purpose:" + lPurpose + "     Thank you TGCAB-HRMS ";
                ...
                {
                    // Emp, controlling
                    string lcontent = "OD Request Cancelled from Controlling Authority   " + lEmployeeFullName + " " + (lEmpCode) + " Starting from " + lStartDate + " to " + lEnDate + "Visting From:" + lVistingFrom + "to " + VistorTo + "Purpose:" + lPurpose + "     Thank you TGCAB-HRMS ";
                    string lEmployee = countrycode + "" + lEmployeemobileno;
                    string lmobilebo = lEmployee;
                   // String URI = "http://push.vg4mobile.com/newBulkClient.jsp?senderID=VGTHYD&msisdn=" + lmobilebo + "&userid=709&msg=" + lcontent + "&pwd=vgthyd1234";
                    String URI = "http://bulkpush.mytoday.com/BulkSms/SingleMsgApi?feedid=351607&username=8686593293&pwd=Tscabaj!1234&time=&msisdn=" + lmobilebo + "&Text=" + lcontent;
                ...
                {
                    // Emp, Sancationing
                    string lcontent = "OD Request Cancelled from Sancationing Authority   " + lEmployeeFullName + " " + (lEmpCode) + " Starting from " + lStartDate + " to " + lEnDate + "Visting From:" + lVistingFrom + "to " + VistorTo + "Purpose:" + lPurpose + "     Thank you TGCAB-HRMS ";
                    string lEmployee = countrycode + "" + lEmployeemobileno;
                    string lmobilebo = lEmployee;
                    //   String URI = "http://push.vg4mobile.com/newBulkClient.jsp?senderID=VGTHYD&msisdn=" + lmobilebo + "&userid=709&msg=" + lcontent + "&pwd=vgthyd1234";
                    String URI = "http://bulkpush.mytoday.com/BulkSms/SingleMsgApi?feedid=351607&username=8686593293&pwd=Tscabaj!1234&time=&msisdn=" + lmobilebo + "&Text=" + lcontent;
