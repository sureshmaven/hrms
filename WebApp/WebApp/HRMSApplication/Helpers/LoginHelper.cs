...
namespace HRMSApplication.Helpers
{
  ...
  public static PayrollModels.LoginCredential GetCurrentUserForPR()
        ...
        public static string GetCurrentUserPages()
        {
            ...
            try
            {
               str= HttpContext.Current.Session["RolePages"].ToString();
            }
            catch (Exception ex)
            {
                LogInformation.Info("LoginHelper.GetCurrentUserPages() - Error occurred: " + ex.Message);
                LogInformation.Info("LoginHelper.GetCurrentUserPages() - Stack trace: " + ex.StackTrace);
                throw;
            }
            ...
            public static LoginCredential GetCurrentUser()
        {
            ...
            {
                LogInformation.Info("LoginHelper.empmemocount() - Error occurred: " + ex.Message);
                LogInformation.Info("LoginHelper.empmemocount() - Stack trace: " + ex.StackTrace);
                throw;
            }
            return lCredentials;
        }
