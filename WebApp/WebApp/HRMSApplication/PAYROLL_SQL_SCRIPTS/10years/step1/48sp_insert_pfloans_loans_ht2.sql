CREATE PROCEDURE [dbo].[sp_insert_pfloans_loans_ht2] @emp_code nvarchar(20) , 
...
@installment_start_date,@installment_end_date,'Interest With Equal Installments',@interest_rate,@installment_amount,@installment_amount,@total_recovered_amount,
'AB-HFL(HYD)',@status,@transidnew,@fm,@fy,@loanslno);
