CREATE PROCEDURE [dbo].[sp_insert_pfloans_adjustments] 
		...
		@os_interest_amount_adj int,
		@completed_installment nvarchar(20), 
		@installment_amount nvarchar(20) , 
		@principal_amount_recovered_one_adj nvarchar(20), 
...
values
(@idnew0,@loan_id, @adv_loans_child_id, @os_priciapl_open_amount, @principal_amount_recovered_one_adj, 
@remaing_amount_adj_festival, @interest_accured_adj, @interest_open_amount, @interest_amount_paid_month,
@interest_amount_recovered_adj, @completed_installment,  @installment_amount, @paid_date, @paid_date,
@completed_installment, @installment_amount, @status, @transidnew, @fm, @fy, @loanslno);
