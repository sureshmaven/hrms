...
@installment_end_date, 'Interest to be Recovered at End' ,@interest_rate,@installment_amount,@installment_amount,@total_recovered_amount,
21,@status,@transidnew,@fm,@fy, @loanslno);
