...
create table test2.dbo.PItCal1920(PMonth nvarchar(10),Eid nvarchar(10),FldName nvarchar(30),TotalAmt nvarchar(10),TaxAmt nvarchar(10),EncashAmt nvarchar(10));

insert into test2.dbo.PItCal1920 select * from test2.dbo.PItCal

select * into test2.dbo.PItOther1920 from test2.dbo.PItOther ;

select * into test2.dbo.PItVal1920 from test2.dbo.PItVal;
