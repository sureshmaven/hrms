...
CREATE PROCEDURE [dbo].[sp_dm_sub_loans_hl2a] @emp_code integer,  @fmn varchar(20)
AS  
...
insert into #two_sub select distinct(LoanId) as loan_id from [TEST2].dbo.PoldLoan where LoanId='HL2A';
