...
Insert into pr_basic_anual_incr_master values(75,(select id from pr_emp_designation where designation='Driver'),'2016-02-01 00:00:00',	9560	,	325	,	4	,1,111);
Insert into pr_basic_anual_incr_master values(76,(select id from pr_emp_designation where designation='Driver'),'2016-02-01 00:00:00',	10860	,	410	,	5	,1,111);
Insert into pr_basic_anual_incr_master values(77,(select id from pr_emp_designation where designation='Driver'),'2016-02-01 00:00:00',	12910	,	490	,	4	,1,111);
Insert into pr_basic_anual_incr_master values(78,(select id from pr_emp_designation where designation='Driver'),'2016-02-01 00:00:00',	14870	,	570	,	3	,1,111);
Insert into pr_basic_anual_incr_master values(79,(select id from pr_emp_designation where designation='Driver'),'2016-02-01 00:00:00',	16580	,	655	,	7	,1,111);
Insert into pr_basic_anual_incr_master values(80,(select id from pr_emp_designation where designation='Driver'),'2016-02-01 00:00:00',	21165	,	735	,	1	,1,111);
Insert into pr_basic_anual_incr_master values(81,(select id from pr_emp_designation where designation='Driver'),'2016-02-01 00:00:00',	21900	,	0	,	0	,1,111);

Insert into pr_basic_anual_incr_master values(82,(select id from pr_emp_designation where designation='Senior Manager'),'2016-02-01 00:00:00',	31705   ,       1145    ,       1,       1,111);
Insert into pr_basic_anual_incr_master values(83,(select id from pr_emp_designation where designation='Senior Manager'),'2016-02-01 00:00:00',	32850	,	1310	,	12	,1,111);
