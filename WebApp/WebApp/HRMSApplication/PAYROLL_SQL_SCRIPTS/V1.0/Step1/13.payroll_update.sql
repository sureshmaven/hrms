...
update all_constants set fy=2021 where app_type='payroll' AND active=1;
...
update pr_emp_inc_date_change set Increment_Date_WEF =inc_date
update pr_emp_inc_anual_stag set Increment_Date_WEF =increment_date
...
UPDATE pr_payslip_customization SET cust_status='Yes' where m_id = (select id from pr_allowance_field_master where name='Faculty Allowance' and type='EMPSA') and field_type='EMPSA';
...
UPDATE pr_payslip_customization SET cust_status='Yes' where m_id = (select id from pr_earn_field_master where name='Special Pay' and type='pay_fields') and field_type='pay_fields';
...
update employees set joineddesignation=29 where joineddesignation=32
update employees set joineddesignation=30 where joineddesignation=33
update employees set joineddesignation=31 where joineddesignation=34
...
update pr_purpose_of_advance_master set purpose_code='RELIGIOUS' where purpose_name='Religious' and ptype='REPAY'	;
update pr_purpose_of_advance_master set purpose_code='MEDICAL' where purpose_name='Medical' and ptype='REPAY'	;
update pr_purpose_of_advance_master set purpose_code='PERSONAL' where purpose_name='Personal' and ptype='REPAY'	;
update pr_purpose_of_advance_master set purpose_code='DOMESTIC' where purpose_name='Domestic' and ptype='REPAY'	;
update pr_purpose_of_advance_master set purpose_code='HigherEducation' where purpose_name='Education' and ptype='REPAY'	;
update pr_purpose_of_advance_master set purpose_code='HOUSING' where purpose_name='Housing' and ptype='REPAY'	;
update pr_purpose_of_advance_master set purpose_code='OTHERS' where purpose_name='Others' and ptype='REPAY'	;

update pr_allowance_field_master set code='SP_ACSTI' where name ='SPL Spl.Alw.ACSTI' and id=49;
update pr_allowance_field_master set code='FPA' where name='Fixed Personal Allowance' and id=3;
update pr_allowance_field_master set code='FPHRA' where name='FPA-HRA Allowance' and id=4;

update pr_deduction_field_master set code='SUBCLUB' where name ='Club Subscription' and type='EPD';
update pr_deduction_field_master set code='SUBST' where name like 'SC/ST Assn ST Subscription' and type='EPD';

update  pr_deduction_field_master set code='APCOBHFCLT' where name ='APCOB-HFC-LT' and type='EPD'
update  pr_deduction_field_master set code='APCOBHFCHO' where name ='APCOB-HFC-HO' and type='EPD'
update  pr_deduction_field_master set code='VIJAYA' where name ='VIJAYA Coop Society Deduction' and type='EPD'
update  pr_deduction_field_master set code='VISAKHA' where name ='VISAKHA Coop Society Deduction' and type='EPD'
update  pr_deduction_field_master set code='GSLI' where name ='GSLI' and type='EPD'
update  pr_deduction_field_master set code='OFFASSN' where name ='Officers Assn Fund' and type='EPD'
update  pr_deduction_field_master set code='OFFASSNC' where name ='Cadre Officers Assn Fund' and type='EPD'
update  pr_deduction_field_master set code='SUBCLUB' where name ='Club Subscription' and type='EPD'
update  pr_deduction_field_master set code='SUBUNION' where name ='Union Club Subscription' and type='EPD'
update  pr_deduction_field_master set code='SUBLT' where name ='SC/ST Assn LT Subscription' and type='EPD'
update  pr_deduction_field_master set code='SUBST' where name ='SC/ST Assn ST Subscription' and type='EPD'
update  pr_deduction_field_master set code='SBF' where name ='LT Staff Benefit Fund' and type='EPD'
update  pr_deduction_field_master set code='VPF' where name ='VPF Deduction' and type='EPD'
update  pr_deduction_field_master set code='LICPENSION' where name ='LIC - PENSION' and type='EPD'
update  pr_deduction_field_master set code='JEEVAN' where name ='JEEVAN SURAKSHA' and type='EPD'
update  pr_deduction_field_master set code='HDCF' where name ='HDFC' and type='EPD'
update  pr_deduction_field_master set code='CCSAP' where name ='CCA - AP' and type='EPD'
update  pr_deduction_field_master set code='CCSHYD' where name ='CCS - HYD' and type='EPD'
update  pr_deduction_field_master set code='ABHLFHYD' where name ='AB-HLF(HYD)' and type='EPD'
update  pr_deduction_field_master set code='APCCADBEMP' where name ='APCCADB - EMP CCS' and type='EPD'
update  pr_deduction_field_master set code='APCOBEDLHNR' where name ='APCOB-ED.LOAN-HNR.BR' and type='EPD'
update  pr_deduction_field_master set code='APCOBEDLHO' where name ='APCOB-ED.LOAN-HO' and type='EPD'
update  pr_deduction_field_master set code='APSCBLTASSN' where name ='APSCB-LT-Emp Assn' and type='EPD'
update  pr_deduction_field_master set code='DRCCSVIZAG' where name ='DR-CCS-VIZAG' and type='EPD'
update  pr_deduction_field_master set code='COURTVIZAG' where name ='PRN-JR CVL JUDGE, VIZAG' and type='EPD'
update  pr_deduction_field_master set code='COURTTANUKU' where name ='1 ADDL JR CVL JUDGE, TANUKU' and type='EPD'
update  pr_deduction_field_master set code='KADAPADCCB' where name ='KADAPA DCCB' and type='EPD'
update  pr_deduction_field_master set code='COURTSLRPET' where name ='JR CVL JUDGE, SULLURPET' and type='EPD'
update  pr_deduction_field_master set code='KMLCOOPBANK' where name ='KML COOP BANK, VIZAG' and type='EPD'
update  pr_deduction_field_master set code='ESTT' where name ='ESTT-EXCESS HRA REC' and type='EPD'
update  pr_deduction_field_master set code='COURTAB' where name ='ANDHRA BANK, RAMANTHPUR' and type='EPD'
update  pr_deduction_field_master set code='COURTKADAPA' where name ='SR.CIVIL JUDGE, KADAPA' and type='EPD'
update  pr_deduction_field_master set code='MEDICALADVANCE' where name ='MEDICAL ADVANCE RECOVERY' and type='EPD'
update  pr_deduction_field_master set code='COURTHYD' where name ='XIX JR.CVL JUDGE, C C COURT, HYDERABAD' and type='EPD'
update  pr_deduction_field_master set code='TGASSN' where name ='BANKS EMP ASSN TELANGANA' and type='EPD'
update  pr_deduction_field_master set code='LICMACHILI' where name ='LIC MACHILIPATNAM' and type='EPD'
update  pr_deduction_field_master set code='VEHMACHILI' where name ='VEHICLE LOAN MACHILIPATNAM' and type='EPD'
update  pr_deduction_field_master set code='Famedhak' where name ='FESTIVAL ADVANCE MEDAK' and type='EPD'
update  pr_deduction_field_master set code='COURTSECBAD' where name ='XI JR.CVL JUDGE, C C COURT, SEC' and type='EPD'
update  pr_deduction_field_master set code='FAELURU' where name ='FESTIVAL ADVANCE ELURU' and type='EPD'
update  pr_deduction_field_master set code='TGUNION' where name ='TELANGANA EMP UNION' and type='EPD'
update  pr_deduction_field_master set code='DCCB' where name ='DCCB DEDUCTION' and type='EPD'
update  pr_deduction_field_master set code='COURTDED' where name ='COURT DEDUCTIONS' and type='EPD'
update  pr_deduction_field_master set code='LIFEINS' where name ='LIFE INSURANCE' and type='EPD'
update  pr_deduction_field_master set code='TOFA' where name ='TELANGANA OFFICERS ASSN' and type='EPD'
update  pr_deduction_field_master set code='TSCABOA' where name ='TSCAB OFFICERS ASSN' and type='EPD'
update  pr_deduction_field_master set code='MISCDED' where name ='MISC. DEDUCTION' and type='EPD'

update  pr_allowance_field_master set code='PH' where name ='Physically Handicapped' and type='EMPA'
update  pr_allowance_field_master set code='DEPU' where name ='Deputation Allowance' and type='EMPA'
update  pr_allowance_field_master set code='FPA' where name ='Fixed Personal Allowance' and type='EMPA'
update  pr_allowance_field_master set code='FPHRA' where name ='FPA-HRA Allowance' and type='EMPA'
update  pr_allowance_field_master set code='FPIIP' where name ='FPIIP' and type='EMPA'
update  pr_allowance_field_master set code='OFFI' where name ='Officiating Allowance' and type='EMPA'
update  pr_allowance_field_master set code='PERPAY' where name ='Personal Pay' and type='EMPA'
update  pr_allowance_field_master set code='PERQPAY' where name ='Personal Qual Allowance' and type='EMPA'
update  pr_allowance_field_master set code='BR_MGR' where name ='Br Manager Allowance' and type='EMPA'
update  pr_allowance_field_master set code='SP_CARETAKE' where name ='SPL Care Taker' and type='EMPSA'
update  pr_allowance_field_master set code='SP_CASHIER' where name ='SPL Cashier' and type='EMPSA'
update  pr_allowance_field_master set code='SP_DRIVER' where name ='SPL Driver' and type='EMPSA'
update  pr_allowance_field_master set code='SP_KEY' where name ='SPL Key' and type='EMPSA'
update  pr_allowance_field_master set code='SP_LIFT' where name ='SPL Lift Operator' and type='EMPSA'
update  pr_allowance_field_master set code='SP_NONPROM' where name ='SPL Non Promotional' and type='EMPSA'
update  pr_allowance_field_master set code='SP_SD_AWARD' where name ='SPL Split Duty -Award staff' and type='EMPSA'
update  pr_allowance_field_master set code='SP_TYPIST' where name ='SPL Typist' and type='EMPSA'
update  pr_allowance_field_master set code='SP_WATCHMAN' where name ='SPL Watchman' and type='EMPSA'
update  pr_allowance_field_master set code='SP_STENO' where name ='SPL Stenographer' and type='EMPSA'
update  pr_allowance_field_master set code='SP_BILLCOLL' where name ='SPL Bill Collector' and type='EMPSA'
update  pr_allowance_field_master set code='SP_DESPATCH' where name ='SPL Despatch' and type='EMPSA'
update  pr_allowance_field_master set code='SP_ELEC' where name ='SPL Electrician' and type='EMPSA'
update  pr_allowance_field_master set code='SP_DAFTARI' where name ='SPL Dafter' and type='EMPSA'
update  pr_allowance_field_master set code='SP_CASHCAD' where name ='SPL Cash Cabin' and type='EMPSA'
update  pr_allowance_field_master set code='SP_TELEPHONE' where name ='SPL Telephone Operator' and type='EMPSA'
update  pr_allowance_field_master set code='SP_LIBRARY' where name ='SPL Library' and type='EMPSA'
update  pr_allowance_field_master set code='SP_INCENTIVE' where name ='SPL Incentive' and type='EMPSA'
update  pr_allowance_field_master set code='SP_ARREAR' where name ='SPL Arrear Incentive' and type='EMPSA'
update  pr_allowance_field_master set code='SP_CONVEY' where name ='SPL Conveyance' and type='EMPSA'
update  pr_allowance_field_master set code='SP_SD_MGR' where name ='SPL Split Duty - Managers' and type='EMPSA'
update  pr_allowance_field_master set code='SP_XEROX' where name ='SPL Duplicating/xerox machine' and type='EMPSA'
update  pr_allowance_field_master set code='SP_RECASST' where name ='SPL Record room asst allowance' and type='EMPSA'
update  pr_allowance_field_master set code='SP_RECSUB' where name ='SPL Record room sub staff all' and type='EMPSA'
update  pr_allowance_field_master set code='SP_RECEPTION' where name ='SPL Receptionist allowance' and type='EMPSA'
update  pr_allowance_field_master set code='SP_ACSTI' where name ='SPL Spl.Alw.ACSTI' and type='EMPSA'
update  pr_allowance_field_master set code='SP_PERPAY' where name ='SPL Personal Pay' and type='EMPSA'
update  pr_allowance_field_master set code='FACULTYALLW' where name ='FACULTY ALLOWANCE' and type='EMPSA'

update pr_earn_field_master set code='CEOALLW' where name='CEO Allowance' and type='adhoc'
update pr_earn_field_master set code='TEACH' where name='Teaching Allowance' and type='pay_fields'
update pr_earn_field_master set code='SPLINCR' where name='Special Increment' and type='pay_fields'


update pr_loan_master set active=1 where loan_id in ('PFHT1','PFHT2','PFLT1','PFLT2','PFLT3','PFLT4');


update pr_interface_vochers_codes set vocher_name='COURT Deduction' where vocher_type = 'Deductions' and vocher_name='COURT Deductions';

update pr_deduction_field_master set emp_master_code='APSCBLTASSN' where emp_master_code='APCOBHFCLT' and type='EPD' and id=39
update pr_deduction_field_master set emp_master_code='COURTAB' where emp_master_code='ANDHBANK' and type='EPD' and id=48
update pr_allowance_field_master set emp_master_code='SP_PERPAY' where emp_master_code='SPLPAY' and type='EMPSA' and id=50
update pr_deduction_field_master set code='FA', emp_master_Code='FA' where name='Festival Advance' and type='adhoc'
update pr_deduction_field_master set id=(select max(id)+1 from pr_deduction_field_master) where name ='MEDICAL INSURANCE IFFCO'

update pr_ob_share set active=1 where fm=(select max(fm) from pr_ob_share)