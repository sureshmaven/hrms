...
CREATE PROCEDURE [dbo].[sp_dm_loan_single_two_wheller] @emp_code integer,  @fmn varchar(20)
AS  
...
insert into #two_sub select distinct(LoanId) as loan_id from [TEST2].dbo.PoldLoan where LoanId='VEH2W';
