...
values
(@idnew0,@loan_id, case when  @priority = 0  then @adv_loans_child_id  when  @priority = 1  then @adv_loans_child_id else @adv_loans_child_id_two end, @os_priciapl_open_amount,@principal_paid_amount, 
