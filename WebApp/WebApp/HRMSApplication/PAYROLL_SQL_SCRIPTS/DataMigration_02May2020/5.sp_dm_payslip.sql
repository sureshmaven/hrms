...
insert into #codes_master_allded select id, name,code,type from pr_deduction_field_master where code!='' and type!='adhoc' union all 
...
insert into #codes_master_allded1 select id, name,code,type from pr_deduction_field_master where code!='' and type!='adhoc'union all 
select id,loan_description as name,loan_id as code,'Loan' as type from pr_loan_master where active=1 and loan_id!='PFL1' and loan_id!='PFL2' union all
select id,name,code,type from dm_payslip_loans where code not in ('PFHT1',
'PFHT2',
'PFLT2',
