...
create PROCEDURE [dbo].[sp_dm_house_plot] @emp_code integer,  @fmn integer
AS  
...
insert into #two_sub select distinct(LoanId) as loan_id from [TEST2].dbo.PoldLoanDet where LoanId='HLPLT';
