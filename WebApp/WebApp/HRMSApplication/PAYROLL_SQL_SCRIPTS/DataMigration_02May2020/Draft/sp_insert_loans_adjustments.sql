...
values
(@idnew0,@loan_id, case when  @priority = 1  then @adv_loans_child_id else @adv_loans_child_id_two end, @os_priciapl_open_amount,case when @loan_code = 'FEST'  then @total_recovered_amount_festival else @total_recovered_amount end, 
@remaing_amount_adj_festival, @interest_accured_adj , @interest_open_amount, @interest_amount_recovered_adj, @principal_amount_recovered_one_adj, 
