CREATE PROCEDURE [dbo].[sp_insert_fest_loans] @emp_code nvarchar(20) , 
...
@installment_start_date,@installment_end_date,'With Out Interest',@interest_rate,@installment_amount,0,@total_recovered_amount,
