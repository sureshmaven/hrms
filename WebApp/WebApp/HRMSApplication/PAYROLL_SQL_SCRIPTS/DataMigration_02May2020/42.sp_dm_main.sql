...
if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%VEH4W%'))
begin
execute sp_dm_sub_loans @empcode, @mn
end		
--rent details
...
if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%PROM%'))
begin
execute sp_dm_promotions @empcode, @mn
end	

if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%IIB%'))
begin
execute sp_dm_jaiib_caiib @empcode, @mn
end	
...
if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%PERS%'))
begin
execute sp_dm_loan_personal  @empcode, @mn
end	
...
if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%VEH2W%'))
begin
execute sp_dm_loan_single_two_wheller  @empcode, @mn
end	

if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%HOUS1%'))
begin
execute sp_dm_sub_loans  @empcode, @mn
end
...
if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%PFLT2%'))
begin
execute sp_dm_loan_pfloans_lt2  @empcode, @mn
end	

if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%PFLT3%'))
begin
execute sp_dm_loan_pfloans_lt3  @empcode, @mn
end

if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%PFLT4%'))
begin
execute sp_dm_loan_pfloans_lt4  @empcode, @mn
end	

if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%HLADD%'))
begin
execute sp_dm_sub_loans_hladd  @empcode, @mn
end	

if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%HL2BC%'))
begin
execute sp_dm_sub_loans_hl2bc  @empcode, @mn
end

if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%HL2A%'))
begin
execute sp_dm_sub_loans_hl2a  @empcode, @mn
end	


if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%ENCASH%'))
begin
execute sp_dm_encashment @empcode, @mn
end

if exists((SELECT * FROM dm_emp_mn_task WHERE task like '%ADHOC%'))
begin
execute sp_dm_adhoc @empcode, @mn
end
