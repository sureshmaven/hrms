...
namespace HRMSBusiness.Timesheet
{
    public class TimesheetBusiness
    {
                        ...
                        qry += "select Convert(varchar(10),cast('" + start + "' as DATETIME),103)" + "as Date," +
                                          " convert(varchar, e.EmpId) + ', ' + e.Shortname + ',' + des.Code + ',' + case when b.Name = 'OtherBranch' then d.Name when b.Name = 'HeadOffice' then d.Name else b.Name end as grpcol" +
                                           " ,sm.OutTime as BranchEndTime,FORMAT(CAST(SUBSTRING(" + "D" + st1s + "," + "7, 5) AS DATETIME),'hh:mm') as EmpCheckOut," +
                                            ...
                                            " join Departments d on e.Department = d.id join shift_master sm on sm.Id = e.Shift_Id where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, GETDATE())" + cond5 + " and " + cond6 + "!=''" + "and " + cond6 + "_Status like '%ED%' Union ";
...

        {
            ...
            else
            {
                if (fromdate != "")
                {
                    ...
                    while ((chunkEnd = start.AddDays(dayChunkSize)) <= end)
                    {
                        ...
                        cond6 = "D" + st1s;
                        string leavetypequery = "select lt.code from leaves l join leavetypes lt on l.leavetype = lt.id join employees e on e.id = l.empid join branches b on e.Branch = b.id join Departments d on e.Department = d.id  where leavesyear = " + s3 + "and '" + start + "' BETWEEN startdate AND enddate and  l.Status in ('Approved','Pending','Forwarded') " + cond5;
                        ...
                        string Empcheckintym = "select distinct case  when SUBSTRING(" + "D" + st1s + "," + "19, 2) Not In ('AB','CL','ML','PL','MTL','PTL','EOL','SCL','LOP','W-Off','C-OFF','CW-OFF','OD-OfWk')  then SUBSTRING(" + "D" + st1s + "," + "19, 2)" +
                                                ...
                                                " where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId != 2 and e.RetirementDate >= convert(Date, '" + start + "')" + cond5 + " and sm.shifttype = (case when(select count(*)" +
                        ...
                        if ((leavetypeName == "CL" || leavetypeName == "CW-OFF") && (EmpcheckintymName == "PR" || EmpcheckintymName == "NA" || EmpcheckintymName == "EA" || EmpcheckintymName == "LA"))
                        {
                            qry += "select " + "D" + st1s + "," + "" + "  Convert(varchar(10),cast('" + start + "'  as DATETIME),103)as Date, convert(varchar, e.EmpId) + ', ' + e.Shortname + ',' + des.Code + ',' + case when b.Name = 'OtherBranch' then d.Name when b.Name = 'HeadOffice' then d.Name else b.Name end as grpcol," +
                                    ...
                                    "'" + start + "' BETWEEN startdate AND enddate and t.year = Year('" + start + "') and t.month = Month('" + start + "')   and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'" +
           ...
           " when " + cond6 + " In ('AB','CL','ML','PL','MTL','PTL','EOL','SCL','LOP','W-Off','C-OFF','CW-OFF') or " + cond6 + " like '%OD%' then " + cond6 +
           " else SUBSTRING(" + "D" + st1s + "," + "1,5) + ( case when D" + st1s + "_meridian is not null then  subString(D" + st1s + "_meridian,1,2) else '' end )  end as EmpCheckInTime," +
           ...
           " when " + cond6 + " In ('AB','CL','ML','PL','MTL','PTL','EOL','SCL','LOP','W-Off','C-OFF','CW-OFF') or " + cond6 + " like '%OD%' then " + cond6 +
           " else SUBSTRING(" + "D" + st1s + "," + "7,5) + ( case when D" + st1s + "_meridian is not null then  subString(D" + st1s + "_meridian,4,2) else '' end ) end as EmpCheckOutTime," +
           " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy" +
                                        ...
                                        " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch join timesheet_logs tl on tl.user_id=t.UserId  where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, GETDATE())" + cond5 + " and " + cond6 + "!='' " + " " +
                        ...
                        qry += "select Convert(varchar(10),cast('" + start + "' as DATETIME),103)" + "as Date," +
                                         "  e.ShortName as EmpName,e.EmpId,des.code as Designation,case when b.name = 'OtherBranch' then d.name when b.name = 'HeadOffice' then d.name else b.name end as BrDept" +
                                           " ,sm.OutTime as BranchEndTime,case when SUBSTRING(D" + st1s + ",28, 2) = 'NA' then SUBSTRING(D" + st1s + ",28, 2) + ''  when D" + st1s + " In ('AB','CL','ML','PL','MTL','PTL','EOL','SCL','LOP','W-Off','C-OFF') or D" + st1s + " like '%OD%' then D" + st1s + " else SUBSTRING(D" + st1s + ",7,5) + ( case when D" + st1s + "_meridian is not null then  subString(D" + st1s + "_meridian,4,2) else '' end ) end as EmpCheckOut," +
                                            ...
                                            " where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, GETDATE())" + cond5 + " and " + cond6 + "!=''" + "and " + cond6 + "_Status like '%ED%' " +
                                            " and  sm.shifttype =(case when(select count(*) from designations " +
            ...
            else
            {
                if (fromdate != "")
                {
                    ...
                    while ((chunkEnd = start.AddDays(dayChunkSize)) <= end)
                    {
                        ...
                        string start1 = chunkend1.ToString("dd/MM/yyyy");
                        string start2 = chunkend1.ToString("yyyy/MM/dd");
                        string start3 = chunkend1.ToString("yyyy-MM-dd");
                        string[] starta = start1.Split('-');
                        string st1s = starta[0];
                        if (st1s.StartsWith("0"))
                        {
                        ...
                        if (empcode == "" && fromdate != string.Empty && todate != string.Empty && (branch == "All" || branch == "HeadOffice-All") && self == "False")
                        {
                            Empcheckintym = "select distinct case  when SUBSTRING(" + "D" + st1s + "," + "19, 2) Not In ('AB','CL','ML','PL','MTL','PTL','EOL','SCL','LOP','W-Off','C-OFF','CW-OFF','OD-OfWk')  then SUBSTRING(" + "D" + st1s + "," + "19, 2)" +
                                                ...
                                                " where leavesyear = " + s3 + " and '" + start + "'  BETWEEN startdate AND enddate and (lt.code = 'CL' or lt.code = 'CW-OFF') and  l.Status in ('Approved','Pending','Forwarded')) and e.EmpId != 2 and e.RetirementDate >= convert(Date, '" + start + "')" + cond5 + " and sm.shifttype = (case when(select count(*)" +
                                                "from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'  else '0' end ) and '" + start + "'  between sm.validfrom and sm.validto and leavesyear = " + s3 + " and  '" + start + "' BETWEEN startdate AND enddate and (lt.code = 'CL' or lt.code = 'CW-OFF') and  l.Status in ('Approved','Pending','Forwarded')";
                            ...
                            if (dt1.Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow leavetym in dt1.Rows)
                                {
                                    ...
                                    if (empid.Count > 0)
                                    {
                                        List<string> idempidList = new List<string>();  // Renamed the list to avoid conflict
                                        string empidString = string.Join(",", empid.Select(emp => $"'{emp}'"));

                                         idqry = $"SELECT Id FROM employees WHERE EmpId IN ({empidString})";
                                        DataTable dtidqry = sh.Get_Table_FromQry(idqry);

                                        foreach (DataRow idq in dtidqry.Rows)
                                        {
                                            idemp = idq["Id"].ToString();
                                            idempidList.Add(idemp);
                                        }

                                        string idString = string.Join(",", idempidList.Select(id => $"'{id}'"));  // Changed the variable name in the Select to 'id'
                                        idcond1 = $"AND l.empid IN ({idString})";

                                        // This condition can be used in other parts of your main query
                                        cond9 = $"AND e.EmpId NOT IN ({empidString})";
                                    }
                                }

                                query = "select distinct t.User_Id as Empid from timesheet_logs t, employees e where e.empid = t.user_id and  t.io_time >= '" + start2 + " 00:00:00.000'  and t.io_time <= '" + start2 + " 23:59:59.000'  and  e.EmpId!=2 and e.RetirementDate >=convert(Date, '" + start + "') order by t.user_id";
                                ...
                                if (dtt.Rows.Count > 0)
                                {
                                        ...
                                        EmpcheckintymName = dt1.AsEnumerable().FirstOrDefault()?[0].ToString();
                                    foreach (DataRow empidco in allemps)
                                    {
                                        AllEmpid = empidco["Empid"].ToString();
                                        ...
                                        else
                                        {
                                            ...
                                            if ((leavetypeName == "CL" || leavetypeName == "CW-OFF") && (EmpcheckintymName == "PR" || EmpcheckintymName == "NA" || EmpcheckintymName == "EA" || EmpcheckintymName == "LA"))
                                            {
                                                qry += "select distinct " + "D" + st1s + "," + "" + "  Convert(varchar(10),cast('" + start + "'  as DATETIME),103)as Date,e.ShortName as EmpName,e.EmpId," +
                                "des.Code as Designation , case when b.Name = 'OtherBranch' then d.Name when b.Name = 'HeadOffice' then d.Name else b.Name end  as BrDept," +
                                      "sm.InTime as BranchStartTime," +
                                       "lt.code as EmpCheckInTime,'00.00' as LateBy,sm.OutTime as BranchCheckOutTime,'' as EmpCheckOutTime,'00.00' as EarlyBy ," +
                                      "'Biometric' as BioManual " +
                                                        "from leaves l join employees e on e.id = l.empid join leavetypes lt on lt.id = l.leavetype join timesheet_emp_month t on t.userid = e.empid join Designations des on e.CurrentDesignation = des.Id join branches b on e.Branch = b.id " +
                                                        "join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch where " +
                                                        "'" + start + "' BETWEEN startdate AND enddate and t.year = Year('" + start + "') and t.month = Month('" + start + "')  "+ idcond1 + "  and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'" +
                                                         " else '0' end ) and '" + start + "'  between sm.validfrom and sm.validto Union ";
                                            }
                                            ...
                                            if (empcheck == true)
                                            {
                                               // StringBuilder qryBuilder = new StringBuilder();
                                                qryBuilder.Append("select distinct ")
                                                    ...
                                                    .Append(" else SUBSTRING(").Append("D").Append(st1s).Append(", 1, 5) + (case when D").Append(st1s).Append("_meridian is not null then  subString(D").Append(st1s).Append("_meridian, 1, 2) else '' end) end as EmpCheckInTime,")
                                                    ...
                                                    .Append(" when ").Append(cond6).Append(" In ('AB','CL','ML','PL','MTL','PTL','EOL','SCL','LOP','W-Off','C-OFF','CW-OFF') or ").Append(cond6).Append(" like '%OD%' then ").Append(cond6)
                                                    .Append(" else SUBSTRING(").Append("D").Append(st1s).Append(", 7, 5) + (case when D").Append(st1s).Append("_meridian is not null then  subString(D").Append(st1s).Append("_meridian, 4, 2) else '' end) end as EmpCheckOutTime,")
                                                    ...
                                                    .Append(" join branches b on e.Branch = b.id  join Departments d on e.Department = d.id")
                                                    .Append(" join shift_master sm on sm.branchid = e.branch ")
                                                    .Append(" where t.year = Year('").Append(start).Append("') and t.month = Month('").Append(start).Append("') and e.EmpId != 2 and e.EmpId != 123456  ").Append(cond9)
                                                    .Append(" and e.RetirementDate >= convert(Date, GETDATE())")
                            ...
                            if (dt1.Rows.Count == 0)
                            {
                                List<string> empidweeks = new List<string>();
                                query = "select distinct t.User_Id as Empid from employees e right join timesheet_logs t on e.empid = t.user_id where  e.EmpId not in (1,2,123456) and e.RetirementDate >=convert(Date, '" + start + "') ";
                                DataTable dtt = sh.Get_Table_FromQry(query);
                                if (dtt.Rows.Count > 0)
                                {
                                    var allemps = dtt.Rows;
                                    ...
                                    foreach (DataRow empid in allemps)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            qryBuilder.Append("select distinct ")
                                                ...
                                                .Append("case when b.Name = 'OtherBranch' then d.Name when b.Name = 'HeadOffice' then d.Name else b.Name end as BrDept,")
                                                .Append("sm.InTime as BranchStartTime,")
                                                .Append("case when ").Append(cond6).Append(" In ('WEEK-OFF','AB') then 'AB' when l.leavetype not in (16) then lt.Code ")
                                                .Append(" when SUBSTRING(").Append("D").Append(st1s).Append(", 19, 2) ").Append(" In ('NA','PR','LA','ED','EA','LD') THEN SUBSTRING(").Append(cond6).Append(", 1, 5) ")
                                                .Append("else ").Append(cond6).Append(" END as EmpCheckInTime,").Append("case when SUBSTRING(").Append("D").Append(st1s).Append(", 19, 2) = 'LA' then  SUBSTRING(")
                                                .Append("D").Append(st1s).Append(", 22, 5) else '00.00' end as LateBy,")
                                                .Append("sm.OutTime as BranchCheckOutTime,")
                                                .Append("case when SUBSTRING(").Append("D").Append(st1s).Append(", 28, 2) ").Append(" In ('NA','PR','LA','ED','EA','LD') THEN SUBSTRING(").Append(cond6).Append(", 7, 5) else '' END as EmpCheckOutTime, ")
                                                .Append("case when SUBSTRING(").Append("D").Append(st1s).Append(", 28, 2) = 'ED' then  SUBSTRING(").Append(cond6).Append(", 31, 5) else '00.00' end as EarlyBy,")
                                                .Append("'Biometric' as BioManual")
                                                .Append(" from  employees e  JOIN branches b ON e.Branch = b.id JOIN Departments d ON e.Department = d.id")
                                                .Append(" JOIN shift_master sm ON sm.branchid = e.branch join designations des on des.id =e.currentDesignation join od_master odm on odm.id = wc.purpose")
                                                .Append(" join timesheet_emp_month tem on tem.userid = e.EmpId join leaves l on l.empid = e.id join leavetypes lt on lt.id = l.leavetype")
                                                .Append(" where tem.year = Year('").Append(start).Append("') and tem.month = Month('").Append(start).Append("') and e.EmpId != 2 and e.EmpId != 123456 ").Append("and e.RetirementDate >= convert(Date, GETDATE())")
                                                .Append(" and wc.purpose = 8 and wc.status = 'Cancelled' and convert(date, wc.startdate) = '").Append(start3).Append("'").Append(cond7)
                                                   .Append(cond5).Append(" and ").Append(cond6).Append(" != '' ")
                                                .Append("and sm.shifttype = (case when (select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1' else '0' end)")
                                                .Append("and '").Append(start).Append("' between sm.validfrom and sm.validto Union ");
                                    ...
                                    if (checkemps == true)
                                    {
                                       ...
                                       // StringBuilder qryBuilder = new StringBuilder();
                                        qryBuilder.Append("select distinct ")
                                            ...
                                            .Append(" join branches b on e.Branch = b.id  join Departments d on e.Department = d.id")
                                            .Append(" join shift_master sm on sm.branchid = e.branch")
                                            .Append(" where t.year = Year('").Append(start).Append("') and t.month = Month('").Append(start).Append("') and e.EmpId != 2 and e.EmpId != 123456 ").Append(" and e.RetirementDate >= convert(Date, GETDATE())")
                                            .Append(" and ").Append("D").Append(st1s).Append(" LIKE ").Append("'%").Append(intime).Append("%'")
                                            .Append(cond5).Append(" and ").Append(cond6).Append(" != '' ")
                                            .Append("and sm.shifttype = (case when (select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1' else '0' end)")
                                            .Append("and '").Append(start).Append("' between sm.validfrom and sm.validto Union ");
                        ...
                        else if (empcode == "" && fromdate != string.Empty && todate != string.Empty && (branch != "All" || branch != "HeadOffice-All") && self == "False")
                        {
                            Empcheckintym = "select distinct case  when SUBSTRING(" + "D" + st1s + "," + "19, 2) Not In ('AB','CL','ML','PL','MTL','PTL','EOL','SCL','LOP','W-Off','C-OFF','CW-OFF','OD-OfWk')  then SUBSTRING(" + "D" + st1s + "," + "19, 2)" +
                                                "end as EmpCheckInTime, t.UserId ,lt.code  from timesheet_emp_month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation = des.Id join branches b on e.Branch = b.id  join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch join leaves  l on e.id = l.empid join leavetypes lt on l.leavetype = lt.id " +
                                                " where t.year = Year('" + start + "') and t.month = Month('" + start + "') and SUBSTRING(" + "D" + st1s + "," + "19, 2) != ''  and t.userid in (select e.empid from leaves l join leavetypes lt on l.leavetype = lt.id join employees e on e.id = l.empid join branches b on e.Branch = b.id join Departments d on e.Department = d.id " +
                        ...
                        {
                            leavetypequery = "select lt.code from leaves l join leavetypes lt on l.leavetype = lt.id join employees e on e.id = l.empid join branches b on e.Branch = b.id join Departments d on e.Department = d.id  where leavesyear = " + s3 + " and '" + start + "' BETWEEN startdate AND enddate and  l.Status in ('Approved','Pending','Forwarded') " + cond5;
                            var dt = sh.Get_Table_FromQry(leavetypequery);
                            leavetypeName = dt.AsEnumerable().FirstOrDefault()?[0].ToString();
                            Empcheckintym = "select distinct case  when SUBSTRING(" + "D" + st1s + "," + "19, 2) Not In ('AB','CL','ML','PL','MTL','PTL','EOL','SCL','LOP','W-Off','C-OFF','CW-OFF','OD-OfWk')  then SUBSTRING(" + "D" + st1s + "," + "19, 2)" +
                                              "end as EmpCheckInTime from timesheet_emp_month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation = des.Id join branches b on e.Branch = b.id join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch" +
                            ...
                            if ((typ != typ1 && typ1 != "" && (typ == "Others" || typ1 == "Others") && branch != "" && fromdate != "") && (typ == "CL" || typ == "PL" || typ == "ML" || typ == "MTL" || typ == "PTL" || typ == "LOP" || typ == "W-Off" || typ == "C-OFF" || typ == "CW-OFF" || typ == "SCL" || typ == "EOL"))
                            {
                                if ((leavetypeName == "CL" || leavetypeName == "CW-OFF") && (EmpcheckintymName == "PR" || EmpcheckintymName == "NA" || EmpcheckintymName == "EA" || EmpcheckintymName == "LA"))
                                {
                                    ...
                                    "des.Code as Designation , case when b.Name = 'OtherBranch' then d.Name when b.Name = 'HeadOffice' then d.Name else b.Name end  as BrDept," +
                                          ...
                                          "'Biometric' as BioManual " +
                                                            "from leaves l join employees e on e.id = l.empid join leavetypes lt on lt.id = l.leavetype join timesheet_emp_month t on t.userid = e.empid join Designations des on e.CurrentDesignation = des.Id join branches b on e.Branch = b.id " +
                                                            "join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch where l.empid = (select id from employees where empid = " + empcode + ") and " +
                                                            "'" + start + "' BETWEEN startdate AND enddate and t.year = Year('" + start + "') and t.month = Month('" + start + "')   and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'" +
                                                             " else '0' end ) and '" + start + "'  between sm.validfrom and sm.validto Union ";
                                }
                                else
                 ...
                 " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual" +
                                              " from timesheet_Emp_Month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id " +
                                              " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch join timesheet_logs tl on tl.user_id=t.UserId  where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, '" + start + "')" + "  and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'  else '0' end )" + " and '" + start + "'  between sm.validfrom and sm.validto and e.empid!=0" + "  Union ";
                                }
                            }
                 ...
                 " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                                              " from timesheet_Emp_Month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id " +
                                              " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch  join timesheet_logs tl on tl.user_id=t.UserId  where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, '" + start + "')" + " and e.empid!=0  " + " and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'  else '0' end )" + " and               '" + start + "'  between sm.validfrom and sm.validto   Union ";
                                }
                            }
                 ...
                 " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                                              " from timesheet_Emp_Month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id " +
                                              " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch join timesheet_logs tl on tl.user_id=t.UserId  where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, '" + start + "')" + " and D" + st1s + " like('%" + typ + "%') and e.empid!=0 " + " and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'  else '0' end )" + " and               '" + start + "'  between sm.validfrom and sm.validto   Union ";
                                }
                            }
                 ...
                 " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                                              " from timesheet_Emp_Month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id " +
                                              " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch  join timesheet_logs tl on tl.user_id=t.UserId   where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, '" + start + "')" + " and D" + st1s + " = '" + typ + "' " + cond5 + " and e.empid!=0 " + " and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'  else '0' end )" + " and               '" + start + "'  between sm.validfrom and sm.validto   Union ";
                                }
                            }
                 ...
                 " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                     ...
                     " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                                                  " from timesheet_Emp_Month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id " +
                                                  " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch  join timesheet_logs tl on tl.user_id=t.UserId  where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, '" + start + "')" + cond5 + " and " + contype2 + " and " + cond6 + "!='' " + " " +
                     ...
                     " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                       ...
                       " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                                                    " from timesheet_Emp_Month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id " +
                                                    " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch join timesheet_logs tl on tl.user_id=t.UserId  where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2" +
                       ...
                       " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                                                    " from timesheet_Emp_Month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id  " +
                                                    " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch   where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 " +
                 ...
                 " case when SUBSTRING(" + "D" + st1s + "," + "28, 2) = 'ED' then  SUBSTRING(" + cond6 + ",31, 5) else '00.00' end as EarlyBy,'Biometric' as BioManual " +
                                              " from timesheet_Emp_Month t join employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id " +
                                              " join Departments d on e.Department = d.id join shift_master sm on sm.branchid = e.branch  join timesheet_logs tl on tl.user_id=t.UserId   where t.year = Year('" + start + "') and t.month = Month('" + start + "') and e.EmpId!=2 and e.RetirementDate >=convert(Date, '" + start + "')" + " and e.empid!=0  " + " and   sm.shifttype =   (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'  else '0' end )" +
                    ...
                    {
                        qrymanual = " Select '00:00#00:00#00:00#EA#00:00#PR#00:00' as D1,Convert(varchar(10),cast(trf.reqfromdate as DATETIME),103) as Date," +
                       " e.ShortName as EmpName, e.Empid as Empid,des.Code as Designation , case when b.Name = 'OtherBranch' then d.Name when b.Name = 'HeadOffice' then d.Name else b.Name end  as BrDept ,sm.InTime as BranchStartTime,trf.entrytime as EmpCheckInTime,'00.00'as LateBy,sm.OutTime as BranchCheckOutTime," +
   ...
   "sum((case when D1_Status  like '%ED%'    then 1  else 0 end) +(case when D2_Status  like '%ED%'    then 1  else 0 end) +(case when D3_Status  like '%ED%'    then 1  else 0 end) +  (case when D4_Status  like '%ED%'    then 1  else 0 end) + (case when D5_Status  like '%ED%'    then 1  else 0 end) + (case when D6_Status  like '%ED%'    then 1  else 0 end) + (case when D7_Status  like '%ED%'    then 1  else 0 end) +  (case when D8_Status  like '%ED%'    then 1  else 0 end) + (case when D9_Status  like '%ED%'    then 1  else 0 end) + (case when D10_Status  like '%ED%'    then 1  else 0 end) + (case when D11_Status  like '%ED%'    then 1  else 0 end) + (case when D12_Status  like '%ED%'    then 1  else 0 end) + (case when D13_Status  like '%ED%'    then 1  else 0 end) + (case when D14_Status  like '%ED%'    then 1  else 0 end) + (case when D15_Status  like '%ED%'    then 1  else 0 end) + (case when D16_Status  like '%ED%'    then 1  else 0 end) + (case when D17_Status  like '%ED%'    then 1  else 0 end) + (case when D18_Status  like '%ED%'    then 1  else 0 end) + (case when D19_Status  like '%ED%'    then 1  else 0 end) + (case when D20_Status  like '%ED%'    then 1  else 0 end) + (case when D21_Status  like '%ED%'    then 1  else 0 end) + (case when D22_Status  like '%ED%'    then 1  else 0 end) + (case when D23_Status  like '%ED%'    then 1  else 0 end) + (case when D24_Status  like '%ED%'    then 1  else 0 end) + (case when D25_Status  like '%ED%'    then 1  else 0 end) + (case when D26_Status  like '%ED%'    then 1  else 0 end) + (case when D27_Status  like '%ED%'    then 1  else 0 end) + (case when D28_Status  like '%ED%'    then 1  else 0 end) + (case when D29_Status  like '%ED%'    then 1  else 0 end) + (case when D30_Status  like '%ED%'    then 1  else 0 end) + (case when D31_Status  like '%ED%'    then 1  else 0 end) + (case when SUBSTRING(D1_Status, 4, 2) = 'NA' THEN 1 else 0 end) + (case when SUBSTRING(D2_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D3_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D4_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D5_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D6_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D7_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D8_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D9_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D10_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D11_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D12_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D13_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D14_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D15_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D16_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D17_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D18_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D19_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D20_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D21_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D22_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D23_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D24_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D25_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D26_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D27_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D28_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D29_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D30_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D31_Status, 4, 2) = 'NA' THEN 1 else 0 end)) as TotalEarlyDepartures  ,sum((case when D1_Status  like '%LA%'    then 1  else 0 end) +(case when D2_Status  like '%LA%'    then 1  else 0 end) +(case when D3_Status  like '%LA%'    then 1  else 0 end) +  (case when D4_Status  like '%LA%'    then 1  else 0 end) + (case when D5_Status  like '%LA%'    then 1  else 0 end) + (case when D6_Status  like '%LA%'    then 1  else 0 end) + (case when D7_Status  like '%LA%'    then 1  else 0 end) +  (case when D8_Status  like '%LA%'    then 1  else 0 end) + (case when D9_Status  like '%LA%'    then 1  else 0 end) + (case when D10_Status  like '%LA%'    then 1  else 0 end) + (case when D11_Status  like '%LA%'    then 1  else 0 end) + (case when D12_Status  like '%LA%'    then 1  else 0 end) + (case when D13_Status  like '%LA%'    then 1  else 0 end) + (case when D14_Status  like '%LA%'    then 1  else 0 end) + (case when D15_Status  like '%LA%'    then 1  else 0 end) + (case when D16_Status  like '%LA%'    then 1  else 0 end) + (case when D17_Status  like '%LA%'    then 1  else 0 end) + (case when D18_Status  like '%LA%'    then 1  else 0 end) + (case when D19_Status  like '%LA%'    then 1  else 0 end) + (case when D20_Status  like '%LA%'    then 1  else 0 end) + (case when D21_Status  like '%LA%'    then 1  else 0 end) + (case when D22_Status  like '%LA%'    then 1  else 0 end) + (case when D23_Status  like '%LA%'    then 1  else 0 end) + (case when D24_Status  like '%LA%'    then 1  else 0 end) + (case when D25_Status  like '%LA%'    then 1  else 0 end) + (case when D26_Status  like '%LA%'    then 1  else 0 end) + (case when D27_Status  like '%LA%'    then 1  else 0 end) + (case when D28_Status  like '%LA%'    then 1  else 0 end) + (case when D29_Status  like '%LA%'    then 1  else 0 end) + (case when D30_Status  like '%LA%'    then 1  else 0 end) + (case when D31_Status  like '%LA%'    then 1  else 0 end) + (case when SUBSTRING(D1_Status, 1, 2) = 'NA' THEN 1 else 0 end) +  (case when SUBSTRING(D2_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D3_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D4_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D5_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D6_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D7_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D8_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D9_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D10_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D11_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D12_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D13_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D14_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D15_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D16_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D17_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D18_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D19_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D20_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D21_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D22_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D23_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D24_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D25_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D26_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D27_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D28_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D29_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D30_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D31_Status, 1, 2) = 'NA' THEN 1 else 0 end)) as TotalLateComes, " +
   "concat((case when D1_Status like  '%ED%' then '01' + '(' +  (SUBSTRING(t.d1, 1, 5)   )+( case when t.D1_meridian is not null then  subString(t.d1_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d1, 7, 5)   )+( case when t.D1_meridian is not null then  subString(t.d1_meridian,4,2) else '' end )+')'  WHEN SUBSTRING(D1_Status, 4, 2) = 'NA' THEN '01' + '(' + SUBSTRING(t.d1, 1, 5) +  (CASE WHEN t.D1_meridian IS NOT NULL THEN SUBSTRING(t.D1_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end) , (case when D2_Status like  '%ED%'     then '<br/>' + '02' + '(' +    (SUBSTRING(t.d2, 1, 5)   )+( case when t.D2_meridian is not null then  subString(t.d2_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d2,7, 5)   )+ ( case when t.D2_meridian is not null then  subString(t.d2_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D2_Status, 4, 2) = 'NA' THEN '<br/>' + '02' + '(' + SUBSTRING(t.d2, 1, 5) +  (CASE WHEN t.D2_meridian IS NOT NULL THEN SUBSTRING(t.D2_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end) ,(case when D3_Status like  '%ED%'     then '<br/>' + '03' + '(' +    (SUBSTRING(t.d3, 1, 5)   ) +( case when t.D3_meridian is not null then  subString(t.d3_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d3,7, 5)   ) +( case when t.D3_meridian is not null then  subString(t.d3_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D3_Status, 4, 2) = 'NA' THEN '<br/>' + '03' + '(' + SUBSTRING(t.d3, 1, 5) +  (CASE WHEN t.D3_meridian IS NOT NULL THEN SUBSTRING(t.D3_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end) ,  (case when D4_Status like  '%ED%'     then '<br/>' + '04' + '(' +    (SUBSTRING(t.d4, 1, 5)   ) +( case when t.D4_meridian is not null then  subString(t.d4_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d4, 7, 5)   ) + ( case when t.D4_meridian is not null then  subString(t.d4_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D4_Status, 4, 2) = 'NA' THEN '<br/>' + '04' + '(' + SUBSTRING(t.d4, 1, 5) +  (CASE WHEN t.D4_meridian IS NOT NULL THEN SUBSTRING(t.D4_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end),(case when D5_Status like  '%ED%'     then '<br/>' + '05' + '(' +    (SUBSTRING(t.d5, 1, 5)   ) + ( case when t.D5_meridian is not null then  subString(t.d5_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d5,7, 5)   ) + ( case when t.D5_meridian is not null then  subString(t.d5_meridian,4,2) else '' end )+')'  WHEN SUBSTRING(D5_Status, 4, 2) = 'NA' THEN '<br/>' + '05' + '(' + SUBSTRING(t.d5, 1, 5) +  (CASE WHEN t.D5_meridian IS NOT NULL THEN SUBSTRING(t.D5_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end), (case when D6_Status like  '%ED%'     then '<br/>' + '06' + '(' +    (SUBSTRING(t.d6, 1, 5)   ) +( case when t.D6_meridian is not null then  subString(t.d6_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d6, 7, 5)   ) + ( case when t.D6_meridian is not null then  subString(t.d6_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D6_Status, 4, 2) = 'NA' THEN '<br/>' + '06' + '(' + SUBSTRING(t.d6, 1, 5) +  (CASE WHEN t.D6_meridian IS NOT NULL THEN SUBSTRING(t.D6_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end), (case when D7_Status like  '%ED%'     then '<br/>' + '07' + '(' +    (SUBSTRING(t.d7, 1, 5)   ) +  ( case when t.D7_meridian is not null then  subString(t.d7_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d7, 7, 5)   ) + ( case when t.D7_meridian is not null then  subString(t.d7_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D7_Status, 4, 2) = 'NA' THEN '<br/>' + '07' + '(' + SUBSTRING(t.d7, 1, 5) +  (CASE WHEN t.D7_meridian IS NOT NULL THEN SUBSTRING(t.D7_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end),  (case when D8_Status like  '%ED%'     then '<br/>' + '08' + '(' +    (SUBSTRING(t.d8, 1, 5)   ) +  ( case when t.D8_meridian is not null then  subString(t.d8_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d8, 7, 5)   ) + ( case when t.D8_meridian is not null then  subString(t.d8_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D8_Status, 4, 2) = 'NA' THEN '<br/>' + '08' + '(' + SUBSTRING(t.d8, 1, 5) +  (CASE WHEN t.D8_meridian IS NOT NULL THEN SUBSTRING(t.D8_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end), (case when D9_Status like  '%ED%'     then '<br/>' + '09' + '(' +    (SUBSTRING(t.d9, 1, 5)   ) + ( case when t.D9_meridian is not null then  subString(t.d9_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d9, 7, 5)   ) + ( case when t.D9_meridian is not null then  subString(t.d9_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D9_Status, 4, 2) = 'NA' THEN '<br/>' + '09' + '(' + SUBSTRING(t.d9, 1, 5) +  (CASE WHEN t.D9_meridian IS NOT NULL THEN SUBSTRING(t.D9_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end), (case when D10_Status like  '%ED%'     then '<br/>' + '10' + '(' +    (SUBSTRING(t.d10,1, 5)   ) + ( case when t.D10_meridian is not null then  subString(t.d10_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d10, 7, 5)   ) +  ( case when t.D10_meridian is not null then  subString(t.d10_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D10_Status, 4, 2) = 'NA' THEN '<br/>' + '10' + '(' + SUBSTRING(t.d10, 1, 5) +  (CASE WHEN t.D10_meridian IS NOT NULL THEN SUBSTRING(t.D10_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end), (case when D11_Status like  '%ED%'     then '<br/>' + '11' + '(' +    (SUBSTRING(t.d11, 1, 5)   ) +  ( case when t.D11_meridian is not null then  subString(t.d11_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d11,7, 5)   ) + ( case when t.D11_meridian is not null then  subString(t.d11_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D11_Status, 4, 2) = 'NA' THEN '<br/>' + '11' + '(' + SUBSTRING(t.d11, 1, 5) +  (CASE WHEN t.D11_meridian IS NOT NULL THEN SUBSTRING(t.D11_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end), (case when D12_Status like  '%ED%'     then '<br/>' + '12' + '(' +    (SUBSTRING(t.d12, 1, 5)   ) + ( case when t.D12_meridian is not null then  subString(t.d12_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d12, 7, 5)   ) +  ( case when t.D12_meridian is not null then  subString(t.d12_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D12_Status, 4, 2) = 'NA' THEN '<br/>' + '12' + '(' + SUBSTRING(t.d12, 1, 5) +  (CASE WHEN t.D12_meridian IS NOT NULL THEN SUBSTRING(t.D12_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end), (case when D13_Status like  '%ED%'     then '<br/>' + '13' + '(' +    (SUBSTRING(t.d13, 1, 5)   ) + ( case when t.D13_meridian is not null then  subString(t.d13_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d13, 7, 5)   ) + ( case when t.D13_meridian is not null then  subString(t.d13_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D13_Status, 4, 2) = 'NA' THEN '<br/>' + '13' + '(' + SUBSTRING(t.d13, 1, 5) +  (CASE WHEN t.D13_meridian IS NOT NULL THEN SUBSTRING(t.D13_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end), (case when D14_Status like  '%ED%'     then '<br/>' + '14' + '(' +    (SUBSTRING(t.d14, 1, 5)   ) + ( case when t.D14_meridian is not null then  subString(t.d14_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d14, 7, 5)   ) + ( case when t.D14_meridian is not null then  subString(t.d14_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D14_Status, 4, 2) = 'NA' THEN '<br/>' + '14' + '(' + SUBSTRING(t.d14, 1, 5) +  (CASE WHEN t.D14_meridian IS NOT NULL THEN SUBSTRING(t.D14_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end), (case when D15_Status like  '%ED%'     then '<br/>' + '15' + '(' +    (SUBSTRING(t.d15, 1, 5)   ) + ( case when t.D15_meridian is not null then  subString(t.d15_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d15, 7, 5)   ) + ( case when t.D15_meridian is not null then  subString(t.d15_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D15_Status, 4, 2) = 'NA' THEN '<br/>' + '15' + '(' + SUBSTRING(t.d15, 1, 5) +  (CASE WHEN t.D15_meridian IS NOT NULL THEN SUBSTRING(t.D15_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end), (case when D16_Status like  '%ED%'     then '<br/>' + '16' + '(' +    (SUBSTRING(t.d16, 1, 5)   ) + ( case when t.D16_meridian is not null then  subString(t.d16_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d16, 7, 5)   ) + ( case when t.D16_meridian is not null then  subString(t.d16_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D16_Status, 4, 2) = 'NA' THEN '<br/>' + '16' + '(' + SUBSTRING(t.d16, 1, 5) +  (CASE WHEN t.D16_meridian IS NOT NULL THEN SUBSTRING(t.D16_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end), (case when D17_Status like  '%ED%'     then '<br/>' + '17' + '(' +    (SUBSTRING(t.d17, 1, 5)   ) + ( case when t.D17_meridian is not null then  subString(t.d17_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d17, 7, 5)   ) + ( case when t.D17_meridian is not null then  subString(t.d17_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D17_Status, 4, 2) = 'NA' THEN '<br/>' + '17' + '(' + SUBSTRING(t.d17, 1, 5) +  (CASE WHEN t.D17_meridian IS NOT NULL THEN SUBSTRING(t.D17_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end), (case when D18_Status like  '%ED%'     then '<br/>' + '18' + '(' +    (SUBSTRING(t.d18, 1, 5)   ) + ( case when t.D18_meridian is not null then  subString(t.d18_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d18, 7, 5)   ) + ( case when t.D16_meridian is not null then  subString(t.d16_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D18_Status, 4, 2) = 'NA' THEN '<br/>' + '18' + '(' + SUBSTRING(t.d18, 1, 5) +  (CASE WHEN t.D18_meridian IS NOT NULL THEN SUBSTRING(t.D18_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end),  (case when D19_Status like  '%ED%'     then '<br/>' + '19' + '(' +    (SUBSTRING(t.d19, 1, 5)   ) + ( case when t.D19_meridian is not null then  subString(t.d19_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d19, 7, 5)   ) + ( case when t.D19_meridian is not null then  subString(t.d19_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D19_Status, 4, 2) = 'NA' THEN '<br/>' + '19' + '(' + SUBSTRING(t.d19, 1, 5) +  (CASE WHEN t.D19_meridian IS NOT NULL THEN SUBSTRING(t.D19_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end),  (case when D20_Status like  '%ED%'     then '<br/>' + '20' + '(' +    (SUBSTRING(t.d20, 1, 5)   ) + ( case when t.D20_meridian is not null then  subString(t.d20_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d20, 7, 5)   ) + ( case when t.D20_meridian is not null then  subString(t.d20_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D20_Status, 4, 2) = 'NA' THEN '<br/>' + '20' + '(' + SUBSTRING(t.d20, 1, 5) +  (CASE WHEN t.D20_meridian IS NOT NULL THEN SUBSTRING(t.D20_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end),  (case when D21_Status like  '%ED%'     then '<br/>' + '21' + '(' +    (SUBSTRING(t.d21, 1, 5)   ) + ( case when t.D21_meridian is not null then  subString(t.d21_meridian,4,2) else '' end )+ '-' +    (SUBSTRING(t.d21, 7, 5)   ) + ( case when t.D21_meridian is not null then  subString(t.d21_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D21_Status, 4, 2) = 'NA' THEN '<br/>' + '21' + '(' + SUBSTRING(t.d21, 1, 5) +  (CASE WHEN t.D21_meridian IS NOT NULL THEN SUBSTRING(t.D21_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end),  (case when D22_Status like  '%ED%'     then '<br/>' + '22' + '(' +    (SUBSTRING(t.d22, 1, 5)   ) +  ( case when t.D22_meridian is not null then  subString(t.d22_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d22, 7, 5)   )  +  ( case when t.D22_meridian is not null then  subString(t.d22_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D22_Status, 4, 2) = 'NA' THEN '<br/>' + '22' + '(' + SUBSTRING(t.d22, 1, 5) +  (CASE WHEN t.D22_meridian IS NOT NULL THEN SUBSTRING(t.D22_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end),   (case when D23_Status like  '%ED%'     then '<br/>' + '23' + '(' +    (SUBSTRING(t.d23, 1, 5)   ) +  ( case when t.D23_meridian is not null then  subString(t.d23_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d23, 7, 5)   ) +  ( case when t.D23_meridian is not null then  subString(t.d23_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D23_Status, 4, 2) = 'NA' THEN '<br/>' + '23' + '(' + SUBSTRING(t.d23, 1, 5) +  (CASE WHEN t.D23_meridian IS NOT NULL THEN SUBSTRING(t.D23_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end), (case when D24_Status like  '%ED%'     then '<br/>' + '24' + '(' +    (SUBSTRING(t.d24, 1, 5)   ) +  ( case when t.D24_meridian is not null then  subString(t.d24_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d24, 7, 5)   ) ++  ( case when t.D24_meridian is not null then  subString(t.d24_meridian,1,2) else '' end )+')' WHEN SUBSTRING(D24_Status, 4, 2) = 'NA' THEN '<br/>' + '24' + '(' + SUBSTRING(t.d2, 1, 5) +  (CASE WHEN t.D24_meridian IS NOT NULL THEN SUBSTRING(t.D24_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end),  (case when D25_Status like  '%ED%'     then '<br/>' + '25' + '(' +    (SUBSTRING(t.d25, 1, 5)   ) +  ( case when t.D25_meridian is not null then  subString(t.d25_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d25, 7, 5)   ) +  ( case when t.D25_meridian is not null then  subString(t.d25_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D25_Status, 4, 2) = 'NA' THEN '<br/>' + '25' + '(' + SUBSTRING(t.d25, 1, 5) +  (CASE WHEN t.D25_meridian IS NOT NULL THEN SUBSTRING(t.D25_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end),  (case when D26_Status like  '%ED%'     then '<br/>' + '26' + '(' +    (SUBSTRING(t.d26, 1, 5)   ) +( case when t.D26_meridian is not null then  subString(t.d26_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d26, 7, 5)   ) +( case when t.D26_meridian is not null then  subString(t.d26_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D26_Status, 4, 2) = 'NA' THEN '<br/>' + '26' + '(' + SUBSTRING(t.d26, 1, 5) +  (CASE WHEN t.D26_meridian IS NOT NULL THEN SUBSTRING(t.D26_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end),(case when D27_Status like  '%ED%'     then '<br/>' + '27' + '(' +    (SUBSTRING(t.d27, 1, 5)   ) +( case when t.D27_meridian is not null then  subString(t.d27_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d27,7, 5)   ) +( case when t.D27_meridian is not null then  subString(t.d27_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D27_Status, 4, 2) = 'NA' THEN '<br/>' + '27' + '(' + SUBSTRING(t.d27, 1, 5) +  (CASE WHEN t.D27_meridian IS NOT NULL THEN SUBSTRING(t.D27_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE '' end),(case when D28_Status like  '%ED%'     then '<br/>' + '28' + '(' +    (SUBSTRING(t.d28, 1, 5)   ) +( case when t.D28_meridian is not null then  subString(t.d28_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d28,7, 5)   )+( case when t.D28_meridian is not null then  subString(t.d28_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D28_Status, 4, 2) = 'NA' THEN '<br/>' + '28' + '(' + SUBSTRING(t.d28, 1, 5) +  (CASE WHEN t.D28_meridian IS NOT NULL THEN SUBSTRING(t.D28_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end),(case when D29_Status like  '%ED%'     then '<br/>' + '29' + '(' +    (SUBSTRING(t.d29, 1, 5)   ) +( case when t.D29_meridian is not null then  subString(t.d29_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d29, 7, 5)   ) +( case when t.D29_meridian is not null then  subString(t.d29_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D29_Status, 4, 2) = 'NA' THEN '<br/>' + '29' + '(' + SUBSTRING(t.d29, 1, 5) +  (CASE WHEN t.D29_meridian IS NOT NULL THEN SUBSTRING(t.D29_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end),(case when D30_Status like  '%ED%'     then '<br/>' + '30' + '(' +    (SUBSTRING(t.d30, 1, 5)   )+( case when t.D30_meridian is not null then  subString(t.d30_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d30, 7, 5)   )+( case when t.D30_meridian is not null then  subString(t.d30_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D30_Status, 4, 2) = 'NA' THEN '<br/>' + '30' + '(' + SUBSTRING(t.d30, 1, 5) +  (CASE WHEN t.D30_meridian IS NOT NULL THEN SUBSTRING(t.D30_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end),(case when D31_Status like  '%ED%'     then '<br/>' + '31' + '(' +    (SUBSTRING(t.d31, 1, 5)   ) +( case when t.D31_meridian is not null then  subString(t.d31_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d31, 7, 5)   ) +( case when t.D31_meridian is not null then  subString(t.d31_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D31_Status, 4, 2) = 'NA' THEN '<br/>' + '31' + '(' + SUBSTRING(t.d31, 1, 5) +  (CASE WHEN t.D31_meridian IS NOT NULL THEN SUBSTRING(t.D31_meridian, 1, 2) ELSE '' END) + '-' + 'NA' + ')' ELSE ''  end)) as EDIntimeOutTime ," +
   "concat((case when D1_Status like  '%LA%'     then '01' + '(' +  (SUBSTRING(t.d1, 1, 5)   )+( case when t.D1_meridian is not null then  subString(t.d1_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d1, 7, 5)   )+( case when t.D1_meridian is not null then  subString(t.d1_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D1_Status, 1, 2) = 'NA' THEN '01' + '('  + 'NA' +'-' + SUBSTRING(t.d1, 7, 5) +  (CASE WHEN t.D1_meridian IS NOT NULL THEN SUBSTRING(t.D1_meridian, 1, 2) ELSE '' END) + ')' ELSE '' end) , (case when D2_Status like  '%LA%'     then '<br/>' + '02' + '(' +    (SUBSTRING(t.d2, 1, 5)   )+ ( case when t.D2_meridian is not null then  subString(t.d2_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d2,7, 5)   )+  ( case when t.D2_meridian is not null then  subString(t.d2_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D2_Status, 1, 2) = 'NA' THEN '<br/>' + '02' + '('  + 'NA' +'-' + SUBSTRING(t.d2, 7, 5) +  (CASE WHEN t.D2_meridian IS NOT NULL THEN SUBSTRING(t.D2_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end) ,  (case when D3_Status like  '%LA%'     then '<br/>' + '03' + '(' +    (SUBSTRING(t.d3, 1, 5)   ) +  ( case when t.D3_meridian is not null then  subString(t.d3_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d3,7, 5)   ) +  ( case when t.D3_meridian is not null then  subString(t.d3_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D3_Status, 1, 2) = 'NA' THEN '<br/>' + '03' + '('  + 'NA' +'-' + SUBSTRING(t.d3, 7, 5) +  (CASE WHEN t.D3_meridian IS NOT NULL THEN SUBSTRING(t.D3_meridian, 1, 2) ELSE '' END) + ')' ELSE '' end) ,    (case when D4_Status like  '%LA%'     then '<br/>' + '04' + '(' +    (SUBSTRING(t.d4, 1, 5)   ) +  ( case when t.D4_meridian is not null then  subString(t.d4_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d4, 7, 5)   ) +   ( case when t.D4_meridian is not null then  subString(t.d4_meridian,4,2) else '' end )+')'  WHEN SUBSTRING(D4_Status, 1, 2) = 'NA' THEN '<br/>' + '04' + '('  + 'NA' +'-' + SUBSTRING(t.d4, 7, 5) +  (CASE WHEN t.D4_meridian IS NOT NULL THEN SUBSTRING(t.D4_meridian, 1, 2) ELSE '' END) + ')' ELSE '' end),  (case when D5_Status like  '%LA%'     then '<br/>' + '05' + '(' +    (SUBSTRING(t.d5, 1, 5)   ) +   ( case when t.D5_meridian is not null then  subString(t.d5_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d5,7, 5)   ) +   ( case when t.D5_meridian is not null then  subString(t.d5_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D5_Status, 1, 2) = 'NA' THEN '<br/>' + '05' + '('  + 'NA' +'-' + SUBSTRING(t.d5, 7, 5) +  (CASE WHEN t.D5_meridian IS NOT NULL THEN SUBSTRING(t.D5_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),  (case when D6_Status like  '%LA%'     then '<br/>' + '06' + '(' +    (SUBSTRING(t.d6, 1, 5)   ) +  ( case when t.D6_meridian is not null then  subString(t.d6_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d6, 7, 5)   ) +   ( case when t.D6_meridian is not null then  subString(t.d6_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D6_Status, 1, 2) = 'NA' THEN '<br/>' + '06' + '('  + 'NA' +'-' + SUBSTRING(t.d6, 7, 5) +  (CASE WHEN t.D1_meridian IS NOT NULL THEN SUBSTRING(t.D1_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),  (case when D7_Status like  '%LA%'     then '<br/>' + '07' + '(' +    (SUBSTRING(t.d7, 1, 5)   ) +   ( case when t.D7_meridian is not null then  subString(t.d7_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d7, 7, 5)   ) +  ( case when t.D7_meridian is not null then  subString(t.d7_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D7_Status, 1, 2) = 'NA' THEN '<br/>' + '07' + '('  + 'NA' +'-' + SUBSTRING(t.d7, 7, 5) + (CASE WHEN t.D7_meridian IS NOT NULL THEN SUBSTRING(t.D7_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),   (case when D8_Status like  '%LA%'     then '<br/>' + '08' + '(' +    (SUBSTRING(t.d8, 1, 5)   ) +   ( case when t.D8_meridian is not null then  subString(t.d8_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d8, 7, 5)   ) +  ( case when t.D8_meridian is not null then  subString(t.d8_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D8_Status, 1, 2) = 'NA' THEN '<br/>' + '08' + '('  + 'NA' +'-' + SUBSTRING(t.d8, 7, 5) +  (CASE WHEN t.D8_meridian IS NOT NULL THEN SUBSTRING(t.D8_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),  (case when D9_Status like  '%LA%'     then '<br/>' + '09' + '(' +    (SUBSTRING(t.d9, 1, 5)   ) +  ( case when t.D9_meridian is not null then  subString(t.d9_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d9, 7, 5)   ) +( case when t.D9_meridian is not null then  subString(t.d9_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D9_Status, 1, 2) = 'NA' THEN '<br/>' + '09' + '('  + 'NA' +'-' + SUBSTRING(t.d9, 7, 5) +  (CASE WHEN t.D1_meridian IS NOT NULL THEN SUBSTRING(t.D1_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),  (case when D10_Status like  '%LA%'     then '<br/>' + '10' + '(' +    (SUBSTRING(t.d10,1, 5)   ) +  ( case when t.D10_meridian is not null then  subString(t.d10_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d10, 7, 5)   ) +   ( case when t.D10_meridian is not null then  subString(t.d10_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D10_Status, 1, 2) = 'NA' THEN '<br/>' + '10' + '('  + 'NA' +'-' + SUBSTRING(t.d10, 7, 5) +  (CASE WHEN t.D10_meridian IS NOT NULL THEN SUBSTRING(t.D10_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),   (case when D11_Status like  '%LA%'     then '<br/>' + '11' + '(' +    (SUBSTRING(t.d11, 1, 5)   ) +    ( case when t.D11_meridian is not null then  subString(t.d11_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d11,7, 5)   ) +	( case when t.D11_meridian is not null then  subString(t.d11_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D11_Status, 1, 2) = 'NA' THEN '<br/>' + '11' + '('  + 'NA' +'-' + SUBSTRING(t.d11, 7, 5) +  (CASE WHEN t.D11_meridian IS NOT NULL THEN SUBSTRING(t.D11_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),(case when D12_Status like  '%LA%'     then '<br/>' + '12' + '(' +    (SUBSTRING(t.d12, 1, 5)   ) +	( case when t.D12_meridian is not null then  subString(t.d12_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d12, 7, 5)   ) + ( case when t.D12_meridian is not null then  subString(t.d12_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D12_Status, 1, 2) = 'NA' THEN '<br/>' + '12' + '('  + 'NA' +'-' + SUBSTRING(t.d12, 7, 5) +  (CASE WHEN t.D12_meridian IS NOT NULL THEN SUBSTRING(t.D12_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),(case when D13_Status like  '%LA%'     then '<br/>' + '13' + '(' +    (SUBSTRING(t.d13, 1, 5)   ) +( case when t.D13_meridian is not null then  subString(t.d13_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d13, 7, 5)   ) + ( case when t.D13_meridian is not null then  subString(t.d13_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D13_Status, 1, 2) = 'NA' THEN '<br/>' + '13' + '('  + 'NA' +'-' + SUBSTRING(t.d13, 7, 5) +  (CASE WHEN t.D13_meridian IS NOT NULL THEN SUBSTRING(t.D13_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),(case when D14_Status like  '%LA%'     then '<br/>' + '14' + '(' +    (SUBSTRING(t.d14, 1, 5)   ) +( case when t.D14_meridian is not null then  subString(t.d14_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d14, 7, 5)   ) +( case when t.D14_meridian is not null then  subString(t.d14_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D14_Status, 1, 2) = 'NA' THEN '<br/>' + '14' + '('  + 'NA' +'-' + SUBSTRING(t.d14, 7, 5) +  (CASE WHEN t.D14_meridian IS NOT NULL THEN SUBSTRING(t.D14_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),(case when D15_Status like  '%LA%'     then '<br/>' + '15' + '(' +    (SUBSTRING(t.d15, 1, 5)   ) +( case when t.D15_meridian is not null then  subString(t.d15_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d15, 7, 5)   ) +( case when t.D15_meridian is not null then  subString(t.d15_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D15_Status, 1, 2) = 'NA' THEN '<br/>' + '15' + '('  + 'NA' +'-' + SUBSTRING(t.d15, 7, 5) + (CASE WHEN t.D15_meridian IS NOT NULL THEN SUBSTRING(t.D15_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end), (case when D16_Status like  '%LA%'     then '<br/>' + '16' + '(' +    (SUBSTRING(t.d16, 1, 5)   ) + ( case when t.D16_meridian is not null then  subString(t.d16_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d16, 7, 5)   ) + ( case when t.D16_meridian is not null then  subString(t.d16_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D16_Status, 1, 2) = 'NA' THEN '<br/>' + '16' + '('  + 'NA' +'-' + SUBSTRING(t.d16, 7, 5) +  (CASE WHEN t.D16_meridian IS NOT NULL THEN SUBSTRING(t.D16_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end), (case when D17_Status like  '%LA%'     then '<br/>' + '17' + '(' +    (SUBSTRING(t.d17, 1, 5)   ) + ( case when t.D17_meridian is not null then  subString(t.d17_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d17, 7, 5)   ) + ( case when t.D17_meridian is not null then  subString(t.d17_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D17_Status, 1, 2) = 'NA' THEN '<br/>' + '17' + '('  + 'NA' +'-' + SUBSTRING(t.d17, 7, 5) +  (CASE WHEN t.D17_meridian IS NOT NULL THEN SUBSTRING(t.D17_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end), (case when D18_Status like  '%LA%'     then '<br/>' + '18' + '(' +    (SUBSTRING(t.d18, 1, 5)   ) + ( case when t.D18_meridian is not null then  subString(t.d18_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d18, 7, 5)   ) + ( case when t.D18_meridian is not null then  subString(t.d18_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D18_Status, 1, 2) = 'NA' THEN '<br/>' + '18' + '('  + 'NA' +'-' + SUBSTRING(t.d18, 7, 5) +  (CASE WHEN t.D18_meridian IS NOT NULL THEN SUBSTRING(t.D18_meridian, 1, 2) ELSE '' END) + ')' ELSE ''   end),  (case when D19_Status like  '%LA%'     then '<br/>' + '19' + '(' +    (SUBSTRING(t.d19, 1, 5)   ) + ( case when t.D19_meridian is not null then  subString(t.d19_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d19, 7, 5)   ) + ( case when t.D19_meridian is not null then  subString(t.d19_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D19_Status, 1, 2) = 'NA' THEN '<br/>' + '19' + '('  + 'NA' +'-' + SUBSTRING(t.d19, 7, 5) +  (CASE WHEN t.D19_meridian IS NOT NULL THEN SUBSTRING(t.D19_meridian, 1, 2) ELSE '' END) + ')' ELSE ''   end),  (case when D20_Status like  '%LA%'     then '<br/>' + '20' + '(' +    (SUBSTRING(t.d20, 1, 5)   ) + ( case when t.D20_meridian is not null then  subString(t.d20_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d20, 7, 5)   ) + ( case when t.D20_meridian is not null then  subString(t.d20_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D20_Status, 1, 2) = 'NA' THEN '<br/>' + '20' + '('  + 'NA' +'-' + SUBSTRING(t.d20, 7, 5) +  (CASE WHEN t.D20_meridian IS NOT NULL THEN SUBSTRING(t.D20_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),  (case when D21_Status like  '%LA%'     then '<br/>' + '21' + '(' +    (SUBSTRING(t.d21, 1, 5)   ) + ( case when t.D21_meridian is not null then  subString(t.d21_meridian,4,2) else '' end )+ '-' +    (SUBSTRING(t.d21, 7, 5)   ) + ( case when t.D21_meridian is not null then  subString(t.d21_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D21_Status, 1, 2) = 'NA' THEN '<br/>' + '21' + '('  + 'NA' +'-' + SUBSTRING(t.d21, 7, 5) +  (CASE WHEN t.D21_meridian IS NOT NULL THEN SUBSTRING(t.D21_meridian, 1, 2) ELSE '' END) + ')' ELSE ''   end),  (case when D22_Status like  '%LA%'     then '<br/>' + '22' + '(' +    (SUBSTRING(t.d22, 1, 5)   ) + ( case when t.D22_meridian is not null then  subString(t.d22_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d22, 7, 5)   )  + ( case when t.D22_meridian is not null then  subString(t.d22_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D22_Status, 1, 2) = 'NA' THEN '<br/>' + '22' + '('  + 'NA' +'-' + SUBSTRING(t.d22, 7, 5) +  (CASE WHEN t.D22_meridian IS NOT NULL THEN SUBSTRING(t.D22_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),  (case when D23_Status like  '%LA%'     then '<br/>' + '23' + '(' +    (SUBSTRING(t.d23, 1, 5)   ) + ( case when t.D23_meridian is not null then  subString(t.d23_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d23, 7, 5)   ) + ( case when t.D23_meridian is not null then  subString(t.d23_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D23_Status, 1, 2) = 'NA' THEN '<br/>' + '23' + '('  + 'NA' +'-' + SUBSTRING(t.d23, 7, 5) +  (CASE WHEN t.D23_meridian IS NOT NULL THEN SUBSTRING(t.D23_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end),  (case when D24_Status like  '%LA%'     then '<br/>' + '24' + '(' +    (SUBSTRING(t.d24, 1, 5)   ) + ( case when t.D24_meridian is not null then  subString(t.d24_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d24, 7, 5)   ) ++ ( case when t.D24_meridian is not null then  subString(t.d24_meridian,1,2) else '' end )+')'WHEN SUBSTRING(D24_Status, 1, 2) = 'NA' THEN '<br/>' + '24' + '('  + 'NA' +'-' + SUBSTRING(t.d24, 7, 5) +  (CASE WHEN t.D24_meridian IS NOT NULL THEN SUBSTRING(t.D24_meridian, 1, 2) ELSE '' END) + ')' ELSE ''   end), (case when D25_Status like  '%LA%'     then '<br/>' + '25' + '(' +    (SUBSTRING(t.d25, 1, 5)   ) + ( case when t.D25_meridian is not null then  subString(t.d25_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d25, 7, 5)   ) + ( case when t.D25_meridian is not null then  subString(t.d25_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D25_Status, 1, 2) = 'NA' THEN '<br/>' + '25' + '('  + 'NA' +'-' + SUBSTRING(t.d25, 7, 5) +  (CASE WHEN t.D25_meridian IS NOT NULL THEN SUBSTRING(t.D25_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end), (case when D26_Status like  '%LA%'     then '<br/>' + '26' + '(' +    (SUBSTRING(t.d26, 1, 5)   ) + ( case when t.D26_meridian is not null then  subString(t.d26_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d26, 7, 5)   ) + ( case when t.D26_meridian is not null then  subString(t.d26_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D26_Status, 1, 2) = 'NA' THEN '<br/>' + '26' + '('  + 'NA' +'-' + SUBSTRING(t.d26, 7, 5) +  (CASE WHEN t.D26_meridian IS NOT NULL THEN SUBSTRING(t.D26_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end), (case when D27_Status like  '%LA%'     then '<br/>' + '27' + '(' +    (SUBSTRING(t.d27, 1, 5)   ) + ( case when t.D27_meridian is not null then  subString(t.d27_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d27,7, 5)   ) + ( case when t.D27_meridian is not null then  subString(t.d27_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D27_Status, 1, 2) = 'NA' THEN '<br/>' + '27' + '('  + 'NA' +'-' + SUBSTRING(t.d27, 7, 5) +  (CASE WHEN t.D27_meridian IS NOT NULL THEN SUBSTRING(t.D27_meridian, 1, 2) ELSE '' END) + ')' ELSE ''   end), (case when D28_Status like  '%LA%'     then '<br/>' + '28' + '(' +    (SUBSTRING(t.d28, 1, 5)   ) + ( case when t.D28_meridian is not null then  subString(t.d28_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d28,7, 5)   )+ ( case when t.D28_meridian is not null then  subString(t.d28_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D28_Status, 1, 2) = 'NA' THEN '<br/>' + '28' + '('  + 'NA' +'-' + SUBSTRING(t.d28, 7, 5) +  (CASE WHEN t.D28_meridian IS NOT NULL THEN SUBSTRING(t.D28_meridian, 1, 2) ELSE '' END) + ')' ELSE ''  end), (case when D29_Status like  '%LA%'     then '<br/>' + '29' + '(' +    (SUBSTRING(t.d29, 1, 5)   ) + ( case when t.D29_meridian is not null then  subString(t.d29_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d29, 7, 5)   ) + ( case when t.D29_meridian is not null then  subString(t.d29_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D29_Status, 1, 2) = 'NA' THEN '<br/>' + '29' + '('  + 'NA' +'-' + SUBSTRING(t.d29, 7, 5) +  (CASE WHEN t.D29_meridian IS NOT NULL THEN SUBSTRING(t.D29_meridian, 1, 2) ELSE '' END) + ')' ELSE ''   end), (case when D30_Status like  '%LA%'     then '<br/>' + '30' + '(' +    (SUBSTRING(t.d30, 1, 5)   )+ ( case when t.D30_meridian is not null then  subString(t.d30_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d30, 7, 5)   )+ ( case when t.D30_meridian is not null then  subString(t.d30_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D30_Status, 1, 2) = 'NA' THEN '<br/>' + '30' + '('  + 'NA' +'-' + SUBSTRING(t.d30, 7, 5) +  (CASE WHEN t.D30_meridian IS NOT NULL THEN SUBSTRING(t.D30_meridian, 1, 2) ELSE '' END) + ')' ELSE ''   end), (case when D31_Status like  '%LA%'     then '<br/>' + '31' + '(' +    (SUBSTRING(t.d31, 1, 5)   ) + ( case when t.D31_meridian is not null then  subString(t.d31_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d31, 7, 5)   ) + ( case when t.D31_meridian is not null then  subString(t.d31_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D31_Status, 1, 2) = 'NA' THEN '<br/>' + '31' + '('  + 'NA' +'-' + SUBSTRING(t.d31, 7, 5) +  (CASE WHEN t.D31_meridian IS NOT NULL THEN SUBSTRING(t.D31_meridian, 1, 2) ELSE '' END) + ')' ELSE ''   end)) as LAIntimeOutTime  " +
 " from timesheet_Emp_Month t" +
   ...
   " and e.EmpId!=2 and (D1_Status   like  '%LA%' or  D1_Status   like  '%ED%'   or  D1_Status   like  '%NA%' or   D2_Status  like  '%LA%'  or  D2_Status   like  '%NA%' or   D2_Status  like  '%ED%'  or  D3_Status  like  '%LA%' or D3_Status  like  '%ED%'  or D3_Status   like  '%NA%'  or D4_Status  like  '%LA%' or D4_Status   like  '%NA%' or D4_Status  like  '%ED%' or D5_Status   like  '%NA%' or D5_Status  like  '%LA%' or D5_Status  like  '%ED%' or D6_Status  like  '%LA%'  or D6_Status   like  '%NA%' or D7_Status  like  '%LA%' or D7_Status   like  '%NA%' or D8_Status   like  '%NA%' or D8_Status  like  '%LA%'  or D9_Status  like  '%LA%' or D9_Status   like  '%NA%' or D10_Status  like  '%LA%' or D10_Status   like  '%NA%' or D11_Status  like  '%LA%' or D11_Status   like  '%NA%' or D12_Status  like  '%LA%' or D12_Status   like  '%NA%' or D13_Status  like  '%LA%' or D13_Status   like  '%NA%' or D14_Status  like  '%LA%' or D14_Status   like  '%NA%' or D15_Status   like  '%NA%'  or D15_Status  like '%LA%' or " +
   "D16_Status  like  '%LA%' or D16_Status   like  '%NA%'  or D17_Status  like  '%LA%' or D17_Status   like  '%NA%' or D17_Status   like  '%NA%' or D18_Status  like  '%LA%' or D18_Status   like  '%NA%' or D19_Status  like  '%LA%' or D19_Status   like  '%NA%'  or D20_Status  like  '%LA%' or D20_Status   like  '%NA%' or D21_Status  like  '%LA%' or D21_Status   like  '%NA%'  or D22_Status  like  '%LA%' or D22_Status   like  '%NA%' or D23_Status  like  '%LA%' or D23_Status   like  '%NA%' or D24_Status  like  '%LA%' or D24_Status   like  '%NA%' or D25_Status  like  '%LA%' or D25_Status   like  '%NA%' or D26_Status  like  '%LA%' or D26_Status   like  '%NA%' or D27_Status  like  '%LA%' or D27_Status   like  '%NA%'  or D28_Status  like  '%LA%' or D28_Status   like  '%NA%' or D29_Status  like  '%LA%' or D29_Status   like  '%NA%' or D30_Status  like  '%LA%' or D30_Status   like  '%NA%' or D31_Status like  '%LA%' or D31_Status   like  '%NA%' or D6_Status  like  '%ED%'  or D7_Status  like  '%ED%'  or D8_Status  like  '%ED%'  or D9_Status  like  '%ED%'  or D10_Status  like  '%ED%'  or D11_Status  like  '%ED%'  or D12_Status  like  '%ED%'  or D13_Status  like  '%ED%'  or D14_Status  like  '%ED%'  or D15_Status  like  '%ED%'  or D16_Status  like  '%ED%'  or D17_Status  like  '%ED%'  or D18_Status  like  '%ED%'  or D19_Status  like  '%ED%'  or D20_Status  like  '%ED%'  or D21_Status  like  '%ED%'  or D22_Status  like  '%ED%'  or D23_Status  like  '%ED%'  or D24_Status  like  '%ED%'  or D25_Status  like  '%ED%'  or D26_Status  like  '%ED%'  or D27_Status  like  '%ED%'  or D28_Status  like  '%ED%'  or D29_Status  like  '%ED%'  or D30_Status  like  '%ED%'  or D31_Status like  '%ED%') " +
...
" (case when D8_Status  like '%ED%'    then 1  else 0 end) + (case when D9_Status  like '%ED%'    then 1  else 0 end) + (case when D10_Status  like '%ED%'    then 1  else 0 end) + (case when D11_Status  like '%ED%'    then 1  else 0 end) + (case when D12_Status  like '%ED%'    then 1  else 0 end) + (case when D13_Status  like '%ED%'    then 1  else 0 end) + (case when D14_Status  like '%ED%'    then 1  else 0 end) + (case when D15_Status  like '%ED%'    then 1  else 0 end) + (case when D16_Status  like '%ED%'    then 1  else 0 end) + (case when D17_Status  like '%ED%'    then 1  else 0 end) + (case when D18_Status  like '%ED%'    then 1  else 0 end) + (case when D19_Status  like '%ED%'    then 1  else 0 end) + (case when D20_Status  like '%ED%'    then 1  else 0 end) + (case when D21_Status  like '%ED%'    then 1  else 0 end) + (case when D22_Status  like '%ED%'    then 1  else 0 end) + (case when D23_Status  like '%ED%'    then 1  else 0 end) + (case when D24_Status  like '%ED%'    then 1  else 0 end) + (case when D25_Status  like '%ED%'    then 1  else 0 end) + (case when D26_Status  like '%ED%'    then 1  else 0 end) + (case when D27_Status  like '%ED%'    then 1  else 0 end) + (case when D28_Status  like '%ED%'    then 1  else 0 end) + (case when D29_Status  like '%ED%'    then 1  else 0 end) + (case when D30_Status  like '%ED%'    then 1  else 0 end) + (case when D31_Status  like '%ED%'    then 1  else 0 end) +" +
   " (case when SUBSTRING(D1_Status, 4, 2) = 'NA' THEN 1 else 0 end) + (case when SUBSTRING(D2_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D3_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D4_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D5_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D6_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D7_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D8_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D9_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D10_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D11_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D12_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D13_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D14_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D15_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D16_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D17_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D18_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D19_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D20_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D21_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D22_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D23_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D24_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D25_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D26_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D27_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D28_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D29_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D30_Status, 4, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D31_Status, 4, 2) = 'NA' THEN 1 else 0 end)) as TotalEarlyDepartures  " +
   ", sum((case when D1_Status  like '%LA%'    then 1  else 0 end) +(case when D2_Status  like '%LA%'    then 1  else 0 end) +(case when D3_Status  like '%LA%'    then 1  else 0 end) +(case when D4_Status  like '%LA%'    then 1  else 0 end) +(case when D5_Status  like '%LA%'    then 1  else 0 end) +(case when D6_Status  like '%LA%'    then 1  else 0 end) +(case when D7_Status  like '%LA%'    then 1  else 0 end) +(case when D8_Status  like '%LA%'    then 1  else 0 end) +(case when D9_Status  like '%LA%'    then 1  else 0 end) +(case when D10_Status  like '%LA%'    then 1  else 0 end) +(case when D11_Status  like '%LA%'    then 1  else 0 end) +(case when D12_Status  like '%LA%'    then 1  else 0 end) +(case when D13_Status  like '%LA%'    then 1  else 0 end) +(case when D14_Status  like '%LA%'    then 1  else 0 end) +(case when D15_Status  like '%LA%'    then 1  else 0 end) +(case when D16_Status  like '%LA%'    then 1  else 0 end) +(case when D17_Status  like '%LA%'    then 1  else 0 end) +(case when D18_Status  like '%LA%'    then 1  else 0 end) +(case when D19_Status  like '%LA%'    then 1  else 0 end) +(case when D20_Status  like '%LA%'    then 1  else 0 end) +(case when D21_Status  like '%LA%'    then 1  else 0 end) +(case when D22_Status  like '%LA%'    then 1  else 0 end) +(case when D23_Status  like '%LA%'    then 1  else 0 end) +(case when D24_Status  like '%LA%'    then 1  else 0 end) +(case when D25_Status  like '%LA%'    then 1  else 0 end) +(case when D26_Status  like '%LA%'    then 1  else 0 end) +(case when D27_Status  like '%LA%'    then 1  else 0 end) +(case when D28_Status  like '%LA%'    then 1  else 0 end) +(case when D29_Status  like '%LA%'    then 1  else 0 end) +(case when D30_Status  like '%LA%'    then 1  else 0 end) +(case when D31_Status  like '%LA%'    then 1  else 0 end) +" +
   "(case when SUBSTRING(D1_Status, 1, 2) = 'NA' THEN 1 else 0 end) +(case when SUBSTRING(D2_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D3_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D4_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D5_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D6_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D7_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D8_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D9_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D10_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D11_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D12_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D13_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D14_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D15_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D16_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D17_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D18_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D19_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D20_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D21_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D22_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D23_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D24_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D25_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D26_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D27_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D28_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D29_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D30_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D31_Status, 1, 2) = 'NA' THEN 1 else 0 end)) as TotalLateComes,  concat((case when D1_Status like  '%LA%'     then '01' + '(' + (SUBSTRING(t.d1, 1, 5)) + ( case when t.D1_meridian is not null then  subString(t.d1_meridian, 1, 2) else '' end )+'-' + (SUBSTRING(t.d1, 7, 5)) + ( case when t.D1_meridian is not null then subString(t.d1_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D1_Status, 1, 2) = 'NA' THEN '01' + '(' + 'NA' + '-' + SUBSTRING(t.d1, 7, 5) + (CASE WHEN t.D1_meridian IS NOT NULL THEN SUBSTRING(t.D1_meridian, 1, 2) ELSE '' END) +')' ELSE '' end) , (case when D2_Status like  '%LA%'     then '<br/>' + '02' + '(' + (SUBSTRING(t.d2, 1, 5)) + ( case when t.D2_meridian is not null then subString(t.d2_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d2, 7, 5)) + ( case when t.D2_meridian is not null then subString(t.d2_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D2_Status, 1, 2) = 'NA' THEN '<br/>' + '02' + '(' + 'NA' + '-' + SUBSTRING(t.d2, 7, 5) + (CASE WHEN t.D2_meridian IS NOT NULL THEN SUBSTRING(t.D2_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end) ,  (case when D3_Status like  '%LA%'     then '<br/>' + '03' + '(' + (SUBSTRING(t.d3, 1, 5)) + ( case when t.D3_meridian is not null then subString(t.d3_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d3, 7, 5)) + ( case when t.D3_meridian is not null then subString(t.d3_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D3_Status, 1, 2) = 'NA' THEN '<br/>' + '03' + '(' + 'NA' + '-' + SUBSTRING(t.d3, 7, 5) + (CASE WHEN t.D3_meridian IS NOT NULL THEN SUBSTRING(t.D3_meridian, 1, 2) ELSE '' END) +')' ELSE '' end) ,    (case when D4_Status like  '%LA%'     then '<br/>' + '04' + '(' + (SUBSTRING(t.d4, 1, 5)) + ( case when t.D4_meridian is not null then subString(t.d4_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d4, 7, 5)) + ( case when t.D4_meridian is not null then subString(t.d4_meridian,4,2) else '' end )+')'  WHEN SUBSTRING(D4_Status, 1, 2) = 'NA' THEN '<br/>' + '04' + '(' + 'NA' + '-' + SUBSTRING(t.d4, 7, 5) + (CASE WHEN t.D4_meridian IS NOT NULL THEN SUBSTRING(t.D4_meridian, 1, 2) ELSE '' END) +')' ELSE '' end),  (case when D5_Status like  '%LA%'     then '<br/>' + '05' + '(' + (SUBSTRING(t.d5, 1, 5)) + ( case when t.D5_meridian is not null then subString(t.d5_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d5, 7, 5)) + ( case when t.D5_meridian is not null then subString(t.d5_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D5_Status, 1, 2) = 'NA' THEN '<br/>' + '05' + '(' + 'NA' + '-' + SUBSTRING(t.d5, 7, 5) + (CASE WHEN t.D5_meridian IS NOT NULL THEN SUBSTRING(t.D5_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),  (case when D6_Status like  '%LA%'     then '<br/>' + '06' + '(' + (SUBSTRING(t.d6, 1, 5)) + ( case when t.D6_meridian is not null then subString(t.d6_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d6, 7, 5)) + ( case when t.D6_meridian is not null then subString(t.d6_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D6_Status, 1, 2) = 'NA' THEN '<br/>' + '06' + '(' + 'NA' + '-' + SUBSTRING(t.d6, 7, 5) + (CASE WHEN t.D1_meridian IS NOT NULL THEN SUBSTRING(t.D1_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),  (case when D7_Status like  '%LA%'     then '<br/>' + '07' + '(' + (SUBSTRING(t.d7, 1, 5)) + ( case when t.D7_meridian is not null then subString(t.d7_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d7, 7, 5)) + ( case when t.D7_meridian is not null then subString(t.d7_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D7_Status, 1, 2) = 'NA' THEN '<br/>' + '07' + '(' + 'NA' + '-' + SUBSTRING(t.d7, 7, 5) + (CASE WHEN t.D7_meridian IS NOT NULL THEN SUBSTRING(t.D7_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),   (case when D8_Status like  '%LA%'     then '<br/>' + '08' + '(' + (SUBSTRING(t.d8, 1, 5)) + ( case when t.D8_meridian is not null then subString(t.d8_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d8, 7, 5)) + ( case when t.D8_meridian is not null then subString(t.d8_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D8_Status, 1, 2) = 'NA' THEN '<br/>' + '08' + '(' + 'NA' + '-' + SUBSTRING(t.d8, 7, 5) + (CASE WHEN t.D8_meridian IS NOT NULL THEN SUBSTRING(t.D8_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),  (case when D9_Status like  '%LA%'     then '<br/>' + '09' + '(' + (SUBSTRING(t.d9, 1, 5)) + ( case when t.D9_meridian is not null then subString(t.d9_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d9, 7, 5)) + ( case when t.D9_meridian is not null then subString(t.d9_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D9_Status, 1, 2) = 'NA' THEN '<br/>' + '09' + '(' + 'NA' + '-' + SUBSTRING(t.d9, 7, 5) + (CASE WHEN t.D1_meridian IS NOT NULL THEN SUBSTRING(t.D1_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),  (case when D10_Status like  '%LA%'     then '<br/>' + '10' + '(' + (SUBSTRING(t.d10, 1, 5)) + ( case when t.D10_meridian is not null then subString(t.d10_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d10, 7, 5)) + ( case when t.D10_meridian is not null then subString(t.d10_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D10_Status, 1, 2) = 'NA' THEN '<br/>' + '10' + '(' + 'NA' + '-' + SUBSTRING(t.d10, 7, 5) + (CASE WHEN t.D10_meridian IS NOT NULL THEN SUBSTRING(t.D10_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),   (case when D11_Status like  '%LA%'     then '<br/>' + '11' + '(' + (SUBSTRING(t.d11, 1, 5)) + ( case when t.D11_meridian is not null then subString(t.d11_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d11, 7, 5)) + ( case when t.D11_meridian is not null then subString(t.d11_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D11_Status, 1, 2) = 'NA' THEN '<br/>' + '11' + '(' + 'NA' + '-' + SUBSTRING(t.d11, 7, 5) + (CASE WHEN t.D11_meridian IS NOT NULL THEN SUBSTRING(t.D11_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),(case when D12_Status like  '%LA%'     then '<br/>' + '12' + '(' + (SUBSTRING(t.d12, 1, 5)) + ( case when t.D12_meridian is not null then subString(t.d12_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d12, 7, 5)) + ( case when t.D12_meridian is not null then subString(t.d12_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D12_Status, 1, 2) = 'NA' THEN '<br/>' + '12' + '(' + 'NA' + '-' + SUBSTRING(t.d12, 7, 5) + (CASE WHEN t.D12_meridian IS NOT NULL THEN SUBSTRING(t.D12_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),(case when D13_Status like  '%LA%'     then '<br/>' + '13' + '(' + (SUBSTRING(t.d13, 1, 5)) + ( case when t.D13_meridian is not null then subString(t.d13_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d13, 7, 5)) + ( case when t.D13_meridian is not null then subString(t.d13_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D13_Status, 1, 2) = 'NA' THEN '<br/>' + '13' + '(' + 'NA' + '-' + SUBSTRING(t.d13, 7, 5) + (CASE WHEN t.D13_meridian IS NOT NULL THEN SUBSTRING(t.D13_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),(case when D14_Status like  '%LA%'     then '<br/>' + '14' + '(' + (SUBSTRING(t.d14, 1, 5)) + ( case when t.D14_meridian is not null then subString(t.d14_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d14, 7, 5)) + ( case when t.D14_meridian is not null then subString(t.d14_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D14_Status, 1, 2) = 'NA' THEN '<br/>' + '14' + '(' + 'NA' + '-' + SUBSTRING(t.d14, 7, 5) + (CASE WHEN t.D14_meridian IS NOT NULL THEN SUBSTRING(t.D14_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),(case when D15_Status like  '%LA%'     then '<br/>' + '15' + '(' + (SUBSTRING(t.d15, 1, 5)) + ( case when t.D15_meridian is not null then subString(t.d15_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d15, 7, 5)) + ( case when t.D15_meridian is not null then subString(t.d15_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D15_Status, 1, 2) = 'NA' THEN '<br/>' + '15' + '(' + 'NA' + '-' + SUBSTRING(t.d15, 7, 5) + (CASE WHEN t.D15_meridian IS NOT NULL THEN SUBSTRING(t.D15_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end), (case when D16_Status like  '%LA%'     then '<br/>' + '16' + '(' + (SUBSTRING(t.d16, 1, 5)) + ( case when t.D16_meridian is not null then subString(t.d16_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d16, 7, 5)) + ( case when t.D16_meridian is not null then subString(t.d16_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D16_Status, 1, 2) = 'NA' THEN '<br/>' + '16' + '(' + 'NA' + '-' + SUBSTRING(t.d16, 7, 5) + (CASE WHEN t.D16_meridian IS NOT NULL THEN SUBSTRING(t.D16_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end), (case when D17_Status like  '%LA%'     then '<br/>' + '17' + '(' + (SUBSTRING(t.d17, 1, 5)) + ( case when t.D17_meridian is not null then subString(t.d17_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d17, 7, 5)) + ( case when t.D17_meridian is not null then subString(t.d17_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D17_Status, 1, 2) = 'NA' THEN '<br/>' + '17' + '(' + 'NA' + '-' + SUBSTRING(t.d17, 7, 5) + (CASE WHEN t.D17_meridian IS NOT NULL THEN SUBSTRING(t.D17_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end), (case when D18_Status like  '%LA%'     then '<br/>' + '18' + '(' + (SUBSTRING(t.d18, 1, 5)) + ( case when t.D18_meridian is not null then subString(t.d18_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d18, 7, 5)) + ( case when t.D18_meridian is not null then subString(t.d18_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D18_Status, 1, 2) = 'NA' THEN '<br/>' + '18' + '(' + 'NA' + '-' + SUBSTRING(t.d18, 7, 5) + (CASE WHEN t.D18_meridian IS NOT NULL THEN SUBSTRING(t.D18_meridian, 1, 2) ELSE '' END) +')' ELSE ''   end),  (case when D19_Status like  '%LA%'     then '<br/>' + '19' + '(' + (SUBSTRING(t.d19, 1, 5)) + ( case when t.D19_meridian is not null then subString(t.d19_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d19, 7, 5)) + ( case when t.D19_meridian is not null then subString(t.d19_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D19_Status, 1, 2) = 'NA' THEN '<br/>' + '19' + '(' + 'NA' + '-' + SUBSTRING(t.d19, 7, 5) + (CASE WHEN t.D19_meridian IS NOT NULL THEN SUBSTRING(t.D19_meridian, 1, 2) ELSE '' END) +')' ELSE ''   end),  (case when D20_Status like  '%LA%'     then '<br/>' + '20' + '(' + (SUBSTRING(t.d20, 1, 5)) + ( case when t.D20_meridian is not null then subString(t.d20_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d20, 7, 5)) + ( case when t.D20_meridian is not null then subString(t.d20_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D20_Status, 1, 2) = 'NA' THEN '<br/>' + '20' + '(' + 'NA' + '-' + SUBSTRING(t.d20, 7, 5) + (CASE WHEN t.D20_meridian IS NOT NULL THEN SUBSTRING(t.D20_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),  (case when D21_Status like  '%LA%'     then '<br/>' + '21' + '(' + (SUBSTRING(t.d21, 1, 5)) + ( case when t.D21_meridian is not null then subString(t.d21_meridian,4,2) else '' end )+'-' + (SUBSTRING(t.d21, 7, 5)) + ( case when t.D21_meridian is not null then subString(t.d21_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D21_Status, 1, 2) = 'NA' THEN '<br/>' + '21' + '(' + 'NA' + '-' + SUBSTRING(t.d21, 7, 5) + (CASE WHEN t.D21_meridian IS NOT NULL THEN SUBSTRING(t.D21_meridian, 1, 2) ELSE '' END) +')' ELSE ''   end),  (case when D22_Status like  '%LA%'     then '<br/>' + '22' + '(' + (SUBSTRING(t.d22, 1, 5)) + ( case when t.D22_meridian is not null then subString(t.d22_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d22, 7, 5)) + ( case when t.D22_meridian is not null then subString(t.d22_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D22_Status, 1, 2) = 'NA' THEN '<br/>' + '22' + '(' + 'NA' + '-' + SUBSTRING(t.d22, 7, 5) + (CASE WHEN t.D22_meridian IS NOT NULL THEN SUBSTRING(t.D22_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),  (case when D23_Status like  '%LA%'     then '<br/>' + '23' + '(' + (SUBSTRING(t.d23, 1, 5)) + ( case when t.D23_meridian is not null then subString(t.d23_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d23, 7, 5)) + ( case when t.D23_meridian is not null then subString(t.d23_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D23_Status, 1, 2) = 'NA' THEN '<br/>' + '23' + '(' + 'NA' + '-' + SUBSTRING(t.d23, 7, 5) + (CASE WHEN t.D23_meridian IS NOT NULL THEN SUBSTRING(t.D23_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end),  (case when D24_Status like  '%LA%'     then '<br/>' + '24' + '(' + (SUBSTRING(t.d24, 1, 5)) + ( case when t.D24_meridian is not null then subString(t.d24_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d24, 7, 5))++( case when t.D24_meridian is not null then  subString(t.d24_meridian, 1, 2) else '' end )+')'WHEN SUBSTRING(D24_Status, 1, 2) = 'NA' THEN '<br/>' + '24' + '(' + 'NA' + '-' + SUBSTRING(t.d24, 7, 5) + (CASE WHEN t.D24_meridian IS NOT NULL THEN SUBSTRING(t.D24_meridian, 1, 2) ELSE '' END) +')' ELSE ''   end), (case when D25_Status like  '%LA%'     then '<br/>' + '25' + '(' + (SUBSTRING(t.d25, 1, 5)) + ( case when t.D25_meridian is not null then subString(t.d25_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d25, 7, 5)) + ( case when t.D25_meridian is not null then subString(t.d25_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D25_Status, 1, 2) = 'NA' THEN '<br/>' + '25' + '(' + 'NA' + '-' + SUBSTRING(t.d25, 7, 5) + (CASE WHEN t.D25_meridian IS NOT NULL THEN SUBSTRING(t.D25_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end), (case when D26_Status like  '%LA%'     then '<br/>' + '26' + '(' + (SUBSTRING(t.d26, 1, 5)) + ( case when t.D26_meridian is not null then subString(t.d26_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d26, 7, 5)) + ( case when t.D26_meridian is not null then subString(t.d26_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D26_Status, 1, 2) = 'NA' THEN '<br/>' + '26' + '(' + 'NA' + '-' + SUBSTRING(t.d26, 7, 5) + (CASE WHEN t.D26_meridian IS NOT NULL THEN SUBSTRING(t.D26_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end), (case when D27_Status like  '%LA%'     then '<br/>' + '27' + '(' + (SUBSTRING(t.d27, 1, 5)) + ( case when t.D27_meridian is not null then subString(t.d27_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d27, 7, 5)) + ( case when t.D27_meridian is not null then subString(t.d27_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D27_Status, 1, 2) = 'NA' THEN '<br/>' + '27' + '(' + 'NA' + '-' + SUBSTRING(t.d27, 7, 5) + (CASE WHEN t.D27_meridian IS NOT NULL THEN SUBSTRING(t.D27_meridian, 1, 2) ELSE '' END) +')' ELSE ''   end), (case when D28_Status like  '%LA%'     then '<br/>' + '28' + '(' + (SUBSTRING(t.d28, 1, 5)) + ( case when t.D28_meridian is not null then subString(t.d28_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d28, 7, 5)) + ( case when t.D28_meridian is not null then subString(t.d28_meridian,4,2) else '' end ) +')' WHEN SUBSTRING(D28_Status, 1, 2) = 'NA' THEN '<br/>' + '28' + '(' + 'NA' + '-' + SUBSTRING(t.d28, 7, 5) + (CASE WHEN t.D28_meridian IS NOT NULL THEN SUBSTRING(t.D28_meridian, 1, 2) ELSE '' END) +')' ELSE ''  end), (case when D29_Status like  '%LA%'     then '<br/>' + '29' + '(' + (SUBSTRING(t.d29, 1, 5)) + ( case when t.D29_meridian is not null then subString(t.d29_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d29, 7, 5)) + ( case when t.D29_meridian is not null then subString(t.d29_meridian,4,2) else '' end )+')'WHEN SUBSTRING(D29_Status, 1, 2) = 'NA' THEN '<br/>' + '29' + '(' + 'NA' + '-' + SUBSTRING(t.d29, 7, 5) + (CASE WHEN t.D29_meridian IS NOT NULL THEN SUBSTRING(t.D29_meridian, 1, 2) ELSE '' END) +')' ELSE ''   end), (case when D30_Status like  '%LA%'     then '<br/>' + '30' + '(' + (SUBSTRING(t.d30, 1, 5)) + ( case when t.D30_meridian is not null then subString(t.d30_meridian,1,2) else '' end ) +'-' + (SUBSTRING(t.d30, 7, 5)) + ( case when t.D30_meridian is not null then subString(t.d30_meridian,4,2) else '' end ) +')'WHEN SUBSTRING(D30_Status, 1, 2) = 'NA' THEN '<br/>' + '30' + '(' + 'NA' + '-' + SUBSTRING(t.d30, 7, 5) + (CASE WHEN t.D30_meridian IS NOT NULL THEN SUBSTRING(t.D30_meridian, 1, 2) ELSE '' END) +')' ELSE ''   end), (case when D31_Status like  '%LA%'     then '<br/>' + '31' + '(' + (SUBSTRING(t.d31, 1, 5)) + ( case when t.D31_meridian is not null then subString(t.d31_meridian,1,2) else '' end )+'-' + (SUBSTRING(t.d31, 7, 5)) + ( case when t.D31_meridian is not null then subString(t.d31_meridian,4,2) else '' end )+')' WHEN SUBSTRING(D31_Status, 1, 2) = 'NA' THEN '<br/>' + '31' + '(' + 'NA' + '-' + SUBSTRING(t.d31, 7, 5) + (CASE WHEN t.D31_meridian IS NOT NULL THEN SUBSTRING(t.D31_meridian, 1, 2) ELSE '' END) +')' ELSE ''   end)) as IntimeOutTime  from timesheet_Emp_Month t" +
   " join Employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id join Departments d on e.Department = d.id " +
   "join shift_master sm on sm.Branchid = e.Branch " +
   " " + cond + " and e.empid!=2  and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'  else '0' end ) and '" + S4 + "'  between sm.validfrom and sm.validto and (D1_Status   like  '%LA%'  or   D2_Status  like  '%LA%'  or  D3_Status  like  '%LA%'  or  D4_Status  like  '%LA%'  or  D5_Status  like  '%LA%'  or  D6_Status  like  '%LA%'  or  D7_Status  like  '%LA%'  or  D8_Status  like  '%LA%'  or  D9_Status  like  '%LA%'  or  D10_Status  like  '%LA%'  or  D11_Status  like  '%LA%'  or  D12_Status  like  '%LA%'  or  D13_Status  like  '%LA%'  or  D14_Status  like  '%LA%'  or  D15_Status  like  '%LA%'  or  D16_Status  like  '%LA%'  or  D17_Status  like  '%LA%'  or  D18_Status  like  '%LA%'  or  D19_Status  like  '%LA%'  or  D20_Status  like  '%LA%'  or  D21_Status  like  '%LA%'  or  D22_Status  like  '%LA%'  or  D23_Status  like  '%LA%'  or  D24_Status  like  '%LA%'  or  D25_Status  like  '%LA%'  or  D26_Status  like  '%LA%'  or  D27_Status  like  '%LA%'  or  D28_Status  like  '%LA%'  or  D29_Status  like  '%LA%'  or  D30_Status  like  '%LA%'  or  D31_Status like  '%LA%' or D1_Status   like  '%NA%'  or   D2_Status  like  '%NA%'  or  D3_Status  like  '%NA%'  or  D4_Status  like  '%NA%'  or D5_Status  like  '%NA%'  or  D6_Status  like  '%NA%'  or  D7_Status  like  '%NA%'  or  D8_Status  like  '%NA%'  or D9_Status  like  '%NA%'  or  D10_Status  like  '%NA%'  or  D11_Status  like  '%NA%'  or  D12_Status  like  '%NA%'  or  D13_Status  like  '%NA%'  or  D14_Status  like  '%NA%'  or  D15_Status  like  '%NA%'  or  D16_Status  like  '%NA%'  or D17_Status  like  '%NA%'  or  D18_Status  like  '%NA%'  or  D19_Status  like  '%NA%'  or  D20_Status  like  '%NA%'  or  D21_Status  like  '%NA%'  or  D22_Status  like  '%NA%'  or  D23_Status  like  '%NA%'  or  D24_Status  like  '%NA%'  or D25_Status  like  '%NA%'  or  D26_Status  like  '%NA%'  or  D27_Status  like  '%NA%'  or  D28_Status  like  '%NA%'  or  D29_Status  like  '%NA%'  or  D30_Status  like  '%NA%'  or  D31_Status like  '%NA%') " +
   " GROUP BY D1_Status,D2_Status,D3_Status,D4_Status,D5_Status,D6_Status,D7_Status,D8_Status,D9_Status,D10_Status,D11_Status,D12_Status,D13_Status,D14_Status,D15_Status,D16_Status,D17_Status,D18_Status,D19_Status,D20_Status,D21_Status,D22_Status,D23_Status,D24_Status,D25_Status,D26_Status,D27_Status,D28_Status,D29_Status,D30_Status,D31_Status,UserId,month,year,ShortName,b.Name,d.Name,des.code,b.StartTime,b.EndTime,sm.InTime,sm.OutTime,t.D1,t.D2 ,t.D3,t.D4,t.D5,t.D6,t.D7,t.D8,t.D9,t.D10,t.D11,t.D12,t.D13,t.D14,t.D15,t.D16,t.D17,t.D18,t.D19,t.D19,t.D20,t.D21,t.D22,t.D23,t.D24,t.D25,t.D26,t.D27,t.D28,t.D29,t.D30,t.D31,t.Id,t.D1_meridian,t.D2_meridian,t.D3_meridian,t.D4_meridian,t.D5_meridian,t.D6_meridian,t.D7_meridian,t.D8_meridian,t.D9_meridian,t.D10_meridian,t.D11_meridian,t.D12_meridian,t.D13_meridian,t.D14_meridian,t.D15_meridian,t.D16_meridian,t.D17_meridian,t.D18_meridian,t.D19_meridian,t.D20_meridian,t.D21_meridian,t.D22_meridian,t.D23_meridian,t.D24_meridian,t.D25_meridian,t.D26_meridian,t.D27_meridian,t.D28_meridian,t.D29_meridian,t.D30_meridian,t.D31_meridian " +
   " having sum((case when D1_Status  like '%LA%'    then 1  else 0 end) +(case when D2_Status  like '%LA%'    then 1  else 0 end) +(case when D3_Status  like '%LA%'    then 1  else 0 end) +  (case when D4_Status  like '%LA%'    then 1  else 0 end) + (case when D5_Status  like '%LA%'    then 1  else 0 end) + (case when D6_Status  like '%LA%'    then 1  else 0 end) + (case when D7_Status  like '%LA%'    then 1  else 0 end) +  (case when D8_Status  like '%LA%'    then 1  else 0 end) + (case when D9_Status  like '%LA%'    then 1  else 0 end) + (case when D10_Status  like '%LA%'    then 1  else 0 end) + (case when D11_Status  like '%LA%'    then 1  else 0 end) + (case when D12_Status  like '%LA%'    then 1  else 0 end) + (case when D13_Status  like '%LA%'    then 1  else 0 end) + (case when D14_Status  like '%LA%'    then 1  else 0 end) + (case when D15_Status  like '%LA%'    then 1  else 0 end) + (case when D16_Status  like '%LA%'    then 1  else 0 end) + (case when D17_Status  like '%LA%'    then 1  else 0 end) + (case when D18_Status  like '%LA%'    then 1  else 0 end) + (case when D19_Status  like '%LA%'    then 1  else 0 end) + (case when D20_Status  like '%LA%'    then 1  else 0 end) + (case when D21_Status  like '%LA%'    then 1  else 0 end) + (case when D22_Status  like '%LA%'    then 1  else 0 end) + (case when D23_Status  like '%LA%'    then 1  else 0 end) + (case when D24_Status  like '%LA%'    then 1  else 0 end) + (case when D25_Status  like '%LA%'    then 1  else 0 end) + (case when D26_Status  like '%LA%'    then 1  else 0 end) + (case when D27_Status  like '%LA%'    then 1  else 0 end) + (case when D28_Status  like '%LA%'    then 1  else 0 end) + (case when D29_Status  like '%LA%'    then 1  else 0 end) + (case when D30_Status  like '%LA%'    then 1  else 0 end) + (case when D31_Status  like '%LA%'    then 1  else 0 end)+(case when SUBSTRING(D1_Status, 1, 2) = 'NA' THEN 1 else 0 end) +  (case when SUBSTRING(D2_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D3_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D4_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D5_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D6_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D7_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D8_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D9_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D10_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D11_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D12_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D13_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D14_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D15_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D16_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D17_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D18_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D19_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D20_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D21_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D22_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D23_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D24_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D25_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D26_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D27_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D28_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D29_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D30_Status, 1, 2) = 'NA' THEN 1 else 0 end)+(case when SUBSTRING(D31_Status, 1, 2) = 'NA' THEN 1 else 0 end))>=3";
...
" (case when D8_Status  like '%ED%'    then 1  else 0 end) + (case when D9_Status  like '%ED%'    then 1  else 0 end) + (case when D10_Status  like '%ED%'    then 1  else 0 end) + (case when D11_Status  like '%ED%'    then 1  else 0 end) + (case when D12_Status  like '%ED%'    then 1  else 0 end) + (case when D13_Status  like '%ED%'    then 1  else 0 end) + (case when D14_Status  like '%ED%'    then 1  else 0 end) + (case when D15_Status  like '%ED%'    then 1  else 0 end) + (case when D16_Status  like '%ED%'    then 1  else 0 end) + (case when D17_Status  like '%ED%'    then 1  else 0 end) + (case when D18_Status  like '%ED%'    then 1  else 0 end) + (case when D19_Status  like '%ED%'    then 1  else 0 end) + (case when D20_Status  like '%ED%'    then 1  else 0 end) + (case when D21_Status  like '%ED%'    then 1  else 0 end) + (case when D22_Status  like '%ED%'    then 1  else 0 end) + (case when D23_Status  like '%ED%'    then 1  else 0 end) + (case when D24_Status  like '%ED%'    then 1  else 0 end) + (case when D25_Status  like '%ED%'    then 1  else 0 end) + (case when D26_Status  like '%ED%'    then 1  else 0 end) + (case when D27_Status  like '%ED%'    then 1  else 0 end) + (case when D28_Status  like '%ED%'    then 1  else 0 end) + (case when D29_Status  like '%ED%'    then 1  else 0 end) + (case when D30_Status  like '%ED%'    then 1  else 0 end) + (case when D31_Status  like '%ED%'    then 1  else 0 end) ) as TotalEarlyDepartures " +
   ...
   " concat((case when D1_Status like  '%LA%'     then '01' + '(' +  (SUBSTRING(t.d1, 1, 5)   )+( case when t.D1_meridian is not null then  subString(t.d1_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d1, 7, 5)   )+( case when t.D1_meridian is not null then  subString(t.d1_meridian,4,2) else '' end )+')'  end) , (case when D2_Status like  '%LA%'     then '<br/>' + '02' + '(' +    (SUBSTRING(t.d2, 1, 5)   )+( case when t.D2_meridian is not null then  subString(t.d2_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d2,7, 5)   )+ ( case when t.D2_meridian is not null then  subString(t.d2_meridian,4,2) else '' end )+')'   end) ,(case when D3_Status like  '%LA%'     then '<br/>' + '03' + '(' +    (SUBSTRING(t.d3, 1, 5)   ) +( case when t.D3_meridian is not null then  subString(t.d3_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d3,7, 5)   ) +( case when t.D3_meridian is not null then  subString(t.d3_meridian,4,2) else '' end ) +')'  end) ,  (case when D4_Status like  '%LA%'     then '<br/>' + '04' + '(' +    (SUBSTRING(t.d4, 1, 5)   ) +( case when t.D4_meridian is not null then  subString(t.d4_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d4, 7, 5)   ) + ( case when t.D4_meridian is not null then  subString(t.d4_meridian,4,2) else '' end )+')'   end),(case when D5_Status like  '%LA%'     then '<br/>' + '05' + '(' +    (SUBSTRING(t.d5, 1, 5)   ) + ( case when t.D5_meridian is not null then  subString(t.d5_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d5,7, 5)   ) + ( case when t.D5_meridian is not null then  subString(t.d5_meridian,4,2) else '' end )+')'   end), (case when D6_Status like  '%LA%'     then '<br/>' + '06' + '(' +    (SUBSTRING(t.d6, 1, 5)   ) +( case when t.D6_meridian is not null then  subString(t.d6_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d6, 7, 5)   ) + ( case when t.D6_meridian is not null then  subString(t.d6_meridian,4,2) else '' end )+')'   end),(case when D7_Status like  '%LA%'     then '<br/>' + '07' + '(' +    (SUBSTRING(t.d7, 1, 5)   ) + ( case when t.D7_meridian is not null then  subString(t.d7_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d7, 7, 5)   ) +( case when t.D7_meridian is not null then  subString(t.d7_meridian,4,2) else '' end )+')'   end), (case when D8_Status like  '%LA%'     then '<br/>' + '08' + '(' +    (SUBSTRING(t.d8, 1, 5)   ) + ( case when t.D8_meridian is not null then  subString(t.d8_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d8, 7, 5)   ) +( case when t.D8_meridian is not null then  subString(t.d8_meridian,4,2) else '' end )+')'  end),(case when D9_Status like  '%LA%'     then '<br/>' + '09' + '(' +    (SUBSTRING(t.d9, 1, 5)   ) +( case when t.D9_meridian is not null then  subString(t.d9_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d9, 7, 5)   ) +( case when t.D9_meridian is not null then  subString(t.d9_meridian,4,2) else '' end )+')'  end),(case when D10_Status like  '%LA%'     then '<br/>' + '10' + '(' +    (SUBSTRING(t.d10,1, 5)   ) +( case when t.D10_meridian is not null then  subString(t.d10_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d10, 7, 5)   ) + ( case when t.D10_meridian is not null then  subString(t.d10_meridian,4,2) else '' end ) +')'  end),(case when D11_Status like  '%LA%'     then '<br/>' + '11' + '(' +    (SUBSTRING(t.d11, 1, 5)   ) + ( case when t.D11_meridian is not null then  subString(t.d11_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d11,7, 5)   ) +( case when t.D11_meridian is not null then  subString(t.d11_meridian,4,2) else '' end )+')'   end),(case when D12_Status like  '%LA%'     then '<br/>' + '12' + '(' +    (SUBSTRING(t.d12, 1, 5)   ) +( case when t.D12_meridian is not null then  subString(t.d12_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d12, 7, 5)   ) + ( case when t.D12_meridian is not null then  subString(t.d12_meridian,4,2) else '' end )+')'  end),(case when D13_Status like  '%LA%'     then '<br/>' + '13' + '(' +    (SUBSTRING(t.d13, 1, 5)   ) +( case when t.D13_meridian is not null then  subString(t.d13_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d13, 7, 5)   ) + ( case when t.D13_meridian is not null then  subString(t.d13_meridian,4,2) else '' end )+')'  end),(case when D14_Status like  '%LA%'     then '<br/>' + '14' + '(' +    (SUBSTRING(t.d14, 1, 5)   ) +( case when t.D14_meridian is not null then  subString(t.d14_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d14, 7, 5)   ) +( case when t.D14_meridian is not null then  subString(t.d14_meridian,4,2) else '' end )+')'  end),(case when D15_Status like  '%LA%'     then '<br/>' + '15' + '(' +    (SUBSTRING(t.d15, 1, 5)   ) +( case when t.D15_meridian is not null then  subString(t.d15_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d15, 7, 5)   ) +( case when t.D15_meridian is not null then  subString(t.d15_meridian,4,2) else '' end ) +')' end),(case when D16_Status like  '%LA%'     then '<br/>' + '16' + '(' +    (SUBSTRING(t.d16, 1, 5)   ) +( case when t.D16_meridian is not null then  subString(t.d16_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d16, 7, 5)   ) +( case when t.D16_meridian is not null then  subString(t.d16_meridian,4,2) else '' end ) +')'  end),(case when D17_Status like  '%LA%'     then '<br/>' + '17' + '(' +    (SUBSTRING(t.d17, 1, 5)   ) +( case when t.D17_meridian is not null then  subString(t.d17_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d17, 7, 5)   ) +( case when t.D17_meridian is not null then  subString(t.d17_meridian,4,2) else '' end )+')'  end),(case when D18_Status like  '%LA%'     then '<br/>' + '18' + '(' +    (SUBSTRING(t.d18, 1, 5)   ) +( case when t.D18_meridian is not null then  subString(t.d18_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d18, 7, 5)   ) +( case when t.D16_meridian is not null then  subString(t.d16_meridian,4,2) else '' end ) +')'  end), (case when D19_Status like  '%LA%'     then '<br/>' + '19' + '(' +    (SUBSTRING(t.d19, 1, 5)   ) +( case when t.D19_meridian is not null then  subString(t.d19_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d19, 7, 5)   ) +( case when t.D19_meridian is not null then  subString(t.d19_meridian,4,2) else '' end )+')'  end), (case when D20_Status like  '%LA%'     then '<br/>' + '20' + '(' +    (SUBSTRING(t.d20, 1, 5)   ) +( case when t.D20_meridian is not null then  subString(t.d20_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d20, 7, 5)   ) +( case when t.D20_meridian is not null then  subString(t.d20_meridian,4,2) else '' end )+')'  end), (case when D21_Status like  '%LA%'     then '<br/>' + '21' + '(' +    (SUBSTRING(t.d21, 1, 5)   ) +( case when t.D21_meridian is not null then  subString(t.d21_meridian,4,2) else '' end )+ '-' +    (SUBSTRING(t.d21, 7, 5)   ) +( case when t.D21_meridian is not null then  subString(t.d21_meridian,4,2) else '' end ) +')'  end), (case when D22_Status like  '%LA%'     then '<br/>' + '22' + '(' +    (SUBSTRING(t.d22, 1, 5)   ) +( case when t.D22_meridian is not null then  subString(t.d22_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d22, 7, 5)   )  +( case when t.D22_meridian is not null then  subString(t.d22_meridian,4,2) else '' end )+')' end), (case when D23_Status like  '%LA%'     then '<br/>' + '23' + '(' +    (SUBSTRING(t.d23, 1, 5)   ) +( case when t.D23_meridian is not null then  subString(t.d23_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d23, 7, 5)   ) +( case when t.D23_meridian is not null then  subString(t.d23_meridian,4,2) else '' end )+')'  end), (case when D24_Status like  '%LA%'     then '<br/>' + '24' + '(' +    (SUBSTRING(t.d24, 1, 5)   ) +( case when t.D24_meridian is not null then  subString(t.d24_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d24, 7, 5)   ) ++( case when t.D24_meridian is not null then  subString(t.d24_meridian,1,2) else '' end )+')'  end),(case when D25_Status like  '%LA%'     then '<br/>' + '25' + '(' +    (SUBSTRING(t.d25, 1, 5)   ) +( case when t.D25_meridian is not null then  subString(t.d25_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d25, 7, 5)   ) +( case when t.D25_meridian is not null then  subString(t.d25_meridian,4,2) else '' end )+')'  end),(case when D26_Status like  '%LA%'     then '<br/>' + '26' + '(' +    (SUBSTRING(t.d26, 1, 5)   ) +( case when t.D26_meridian is not null then  subString(t.d26_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d26, 7, 5)   ) +( case when t.D26_meridian is not null then  subString(t.d26_meridian,4,2) else '' end )+')'  end),(case when D27_Status like  '%LA%'     then '<br/>' + '27' + '(' +    (SUBSTRING(t.d27, 1, 5)   ) +( case when t.D27_meridian is not null then  subString(t.d27_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d27,7, 5)   ) +( case when t.D27_meridian is not null then  subString(t.d27_meridian,4,2) else '' end )+')'  end),(case when D28_Status like  '%LA%'     then '<br/>' + '28' + '(' +    (SUBSTRING(t.d28, 1, 5)   ) +( case when t.D28_meridian is not null then  subString(t.d28_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d28,7, 5)   )+( case when t.D28_meridian is not null then  subString(t.d28_meridian,4,2) else '' end ) +')'  end),(case when D29_Status like  '%LA%'     then '<br/>' + '29' + '(' +    (SUBSTRING(t.d29, 1, 5)   ) +( case when t.D29_meridian is not null then  subString(t.d29_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d29, 7, 5)   ) +( case when t.D29_meridian is not null then  subString(t.d29_meridian,4,2) else '' end )+')'  end),(case when D30_Status like  '%LA%'     then '<br/>' + '30' + '(' +    (SUBSTRING(t.d30, 1, 5)   )+( case when t.D30_meridian is not null then  subString(t.d30_meridian,1,2) else '' end ) + '-' +    (SUBSTRING(t.d30, 7, 5)   )+( case when t.D30_meridian is not null then  subString(t.d30_meridian,4,2) else '' end ) +')'  end),(case when D31_Status like  '%LA%'     then '<br/>' + '31' + '(' +    (SUBSTRING(t.d31, 1, 5)   ) +( case when t.D31_meridian is not null then  subString(t.d31_meridian,1,2) else '' end )+ '-' +    (SUBSTRING(t.d31, 7, 5)   ) +( case when t.D31_meridian is not null then  subString(t.d31_meridian,4,2) else '' end )+')'  end)) as IntimeOutTime" +
   " ,concat((CASE WHEN D1_Status LIKE '%NA%' THEN '01' + '(' + (CASE WHEN SUBSTRING(t.d1, 19, 2) != 'NA' THEN SUBSTRING(t.d1, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d1, 19, 2) != 'NA' THEN (CASE WHEN t.D1_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D1_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d1, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d1, 28, 2) != 'NA' THEN SUBSTRING(t.d1, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d1, 28, 2) != 'NA' THEN (CASE WHEN t.D1_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D1_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d1, 28, 2) = 'NA' THEN 'NA' ELSE '' END) + ')'END) , (case when D2_Status like  '%NA%'     then '<br/>' + '02' + '(' +    (CASE WHEN SUBSTRING(t.d2, 19, 2) != 'NA' THEN SUBSTRING(t.d2, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d2, 19, 2) != 'NA' THEN (CASE WHEN t.D2_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D2_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d2, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d2, 28, 2) != 'NA' THEN SUBSTRING(t.d2, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d2, 28, 2) != 'NA' THEN (CASE WHEN t.D2_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D2_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d2, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'   end) ,(case when D3_Status like  '%NA%'     then '<br/>' + '03' + '(' +    (CASE WHEN SUBSTRING(t.d3, 19, 2) != 'NA' THEN SUBSTRING(t.d3, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d3, 19, 2) != 'NA' THEN (CASE WHEN t.D3_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D3_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d3, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' + (CASE WHEN SUBSTRING(t.d3, 28, 2) != 'NA' THEN SUBSTRING(t.d3, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d3, 28, 2) != 'NA' THEN (CASE WHEN t.D3_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D3_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d3, 28, 2) = 'NA' THEN 'NA' ELSE '' END)  +')'  end) ,(case when D4_Status like  '%NA%'     then '<br/>' + '04' + '(' +   (CASE WHEN SUBSTRING(t.d4, 19, 2) != 'NA' THEN SUBSTRING(t.d4, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d4, 19, 2) != 'NA' THEN (CASE WHEN t.D4_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D4_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d4, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' + (CASE WHEN SUBSTRING(t.d4, 28, 2) != 'NA' THEN SUBSTRING(t.d4, 7, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d4, 28, 2) != 'NA' THEN (CASE WHEN t.D4_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D4_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d4, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'   end),(case when D5_Status like  '%NA%'     then '<br/>' + '05' + '(' +    (CASE WHEN SUBSTRING(t.d5, 19, 2) != 'NA' THEN SUBSTRING(t.d5, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d5, 19, 2) != 'NA' THEN (CASE WHEN t.D5_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D5_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d5, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' + (CASE WHEN SUBSTRING(t.d5, 28, 2) != 'NA' THEN SUBSTRING(t.d5, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d5, 28, 2) != 'NA' THEN (CASE WHEN t.D5_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D5_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d5, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'   end),(case when D6_Status like  '%NA%'     then '<br/>' + '06' + '(' +    (CASE WHEN SUBSTRING(t.d6, 19, 2) != 'NA' THEN SUBSTRING(t.d6, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d6, 19, 2) != 'NA' THEN (CASE WHEN t.D6_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D6_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d6, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d6, 28, 2) != 'NA' THEN SUBSTRING(t.d6, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d6, 28, 2) != 'NA' THEN (CASE WHEN t.D6_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D6_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d6, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'   end),(case when D7_Status like  '%NA%'     then '<br/>' + '07' + '(' +    (CASE WHEN SUBSTRING(t.d7, 19, 2) != 'NA' THEN SUBSTRING(t.d7, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d7, 19, 2) != 'NA' THEN (CASE WHEN t.D7_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D7_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d7, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d7, 28, 2) != 'NA' THEN SUBSTRING(t.d7, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d7, 28, 2) != 'NA' THEN (CASE WHEN t.D7_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D7_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d7, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'   end), (case when D8_Status like  '%NA%'     then '<br/>' + '08' + '(' +    (CASE WHEN SUBSTRING(t.d8, 19, 2) != 'NA' THEN SUBSTRING(t.d8, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d8, 19, 2) != 'NA' THEN (CASE WHEN t.D1_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D8_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d8, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d8, 28, 2) != 'NA' THEN SUBSTRING(t.d8, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d8, 28, 2) != 'NA' THEN (CASE WHEN t.D8_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D8_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d8, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D9_Status like  '%NA%'     then '<br/>' + '09' + '(' +   (CASE WHEN SUBSTRING(t.d9, 19, 2) != 'NA' THEN SUBSTRING(t.d9, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d9, 19, 2) != 'NA' THEN (CASE WHEN t.D9_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D9_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d9, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d9, 28, 2) != 'NA' THEN SUBSTRING(t.d9, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d9, 28, 2) != 'NA' THEN (CASE WHEN t.D9_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D9_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d9, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D10_Status like  '%NA%'     then '<br/>' + '10' + '(' +   (CASE WHEN SUBSTRING(t.d10, 19, 2) != 'NA' THEN SUBSTRING(t.d10, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d10, 19, 2) != 'NA' THEN (CASE WHEN t.D10_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D10_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d10, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d10, 28, 2) != 'NA' THEN SUBSTRING(t.d10, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d10, 28, 2) != 'NA' THEN (CASE WHEN t.D10_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D10_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d10, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D11_Status like  '%NA%'     then '<br/>' + '11' + '(' +   (CASE WHEN SUBSTRING(t.d11, 19, 2) != 'NA' THEN SUBSTRING(t.d11, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d11, 19, 2) != 'NA' THEN (CASE WHEN t.D11_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D11_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d11, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d11, 28, 2) != 'NA' THEN SUBSTRING(t.d11, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d11, 28, 2) != 'NA' THEN (CASE WHEN t.D11_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D11_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d11, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'   end),(case when D12_Status like  '%NA%'     then '<br/>' + '12' + '(' +  (CASE WHEN SUBSTRING(t.d12, 19, 2) != 'NA' THEN SUBSTRING(t.d12, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d12, 19, 2) != 'NA' THEN (CASE WHEN t.D12_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D12_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d12, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d12, 28, 2) != 'NA' THEN SUBSTRING(t.d12, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d12, 28, 2) != 'NA' THEN (CASE WHEN t.D12_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D12_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d12, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D13_Status like  '%NA%'     then '<br/>' + '13' + '(' +  (CASE WHEN SUBSTRING(t.d13, 19, 2) != 'NA' THEN SUBSTRING(t.d13, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d13, 19, 2) != 'NA' THEN (CASE WHEN t.D13_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D13_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d13, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d13, 28, 2) != 'NA' THEN SUBSTRING(t.d13, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d13, 28, 2) != 'NA' THEN (CASE WHEN t.D13_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D13_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d13, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D14_Status like  '%NA%'     then '<br/>' + '14' + '(' +   (CASE WHEN SUBSTRING(t.d14, 19, 2) != 'NA' THEN SUBSTRING(t.d14, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d14, 19, 2) != 'NA' THEN (CASE WHEN t.D1_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D14_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d14, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d14, 28, 2) != 'NA' THEN SUBSTRING(t.d14, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d14, 28, 2) != 'NA' THEN (CASE WHEN t.D14_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D14_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d14, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D15_Status like  '%NA%'     then '<br/>' + '15' + '(' +   (CASE WHEN SUBSTRING(t.d15, 19, 2) != 'NA' THEN SUBSTRING(t.d15, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d15, 19, 2) != 'NA' THEN (CASE WHEN t.D1_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D15_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d15, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d15, 28, 2) != 'NA' THEN SUBSTRING(t.d15, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d15, 28, 2) != 'NA' THEN (CASE WHEN t.D15_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D15_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d15, 28, 2) = 'NA' THEN 'NA' ELSE '' END)  +')' end),(case when D16_Status like  '%NA%'     then '<br/>' + '16' + '(' +   (CASE WHEN SUBSTRING(t.d16, 19, 2) != 'NA' THEN SUBSTRING(t.d16, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d16, 19, 2) != 'NA' THEN (CASE WHEN t.D16_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D16_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d16, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d16, 28, 2) != 'NA' THEN SUBSTRING(t.d16, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d16, 28, 2) != 'NA' THEN (CASE WHEN t.D16_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D16_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d16, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D17_Status like  '%NA%'     then '<br/>' + '17' + '(' +  (CASE WHEN SUBSTRING(t.d17, 19, 2) != 'NA' THEN SUBSTRING(t.d17, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d17, 19, 2) != 'NA' THEN (CASE WHEN t.D17_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D17_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d17, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d17, 28, 2) != 'NA' THEN SUBSTRING(t.d17, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d17, 28, 2) != 'NA' THEN (CASE WHEN t.D17_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D17_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d17, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D18_Status like  '%NA%'     then '<br/>' + '18' + '(' +   (CASE WHEN SUBSTRING(t.d18, 19, 2) != 'NA' THEN SUBSTRING(t.d18, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d18, 19, 2) != 'NA' THEN (CASE WHEN t.D18_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D18_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d18, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d18, 28, 2) != 'NA' THEN SUBSTRING(t.d18, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d18, 28, 2) != 'NA' THEN (CASE WHEN t.D18_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D18_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d18, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end), (case when D19_Status like  '%NA%'     then '<br/>' + '19' + '(' +  (CASE WHEN SUBSTRING(t.d19, 19, 2) != 'NA' THEN SUBSTRING(t.d19, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d19, 19, 2) != 'NA' THEN (CASE WHEN t.D19_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D19_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d19, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d19, 28, 2) != 'NA' THEN SUBSTRING(t.d19, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d19, 28, 2) != 'NA' THEN (CASE WHEN t.D19_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D19_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d19, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end), (case when D20_Status like  '%NA%'     then '<br/>' + '20' + '(' +  (CASE WHEN SUBSTRING(t.d20, 19, 2) != 'NA' THEN SUBSTRING(t.d20, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d20, 19, 2) != 'NA' THEN (CASE WHEN t.D20_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D20_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d20, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +           (CASE WHEN SUBSTRING(t.d20, 28, 2) != 'NA' THEN SUBSTRING(t.d20, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d20, 28, 2) != 'NA' THEN (CASE WHEN t.D20_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D20_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d20, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end), (case when D21_Status like  '%NA%'     then '<br/>' + '21' + '(' +    (CASE WHEN SUBSTRING(t.d21, 19, 2) != 'NA' THEN SUBSTRING(t.d21, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d21, 19, 2) != 'NA' THEN (CASE WHEN t.D21_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D21_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d21, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' + (CASE WHEN SUBSTRING(t.d21, 28, 2) != 'NA' THEN SUBSTRING(t.d21, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d21, 28, 2) != 'NA' THEN (CASE WHEN t.D21_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D21_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d21, 28, 2) = 'NA' THEN 'NA' ELSE '' END)  +')'  end), (case when D22_Status like  '%NA%'     then '<br/>' + '22' + '(' +   (CASE WHEN SUBSTRING(t.d22, 19, 2) != 'NA' THEN SUBSTRING(t.d22, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d22, 19, 2) != 'NA' THEN (CASE WHEN t.D22_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D22_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d22, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' + (CASE WHEN SUBSTRING(t.d22, 28, 2) != 'NA' THEN SUBSTRING(t.d22, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d22, 28, 2) != 'NA' THEN (CASE WHEN t.D22_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D22_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d22, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')' end), (case when D23_Status like  '%NA%'     then '<br/>' + '23' + '(' +   (CASE WHEN SUBSTRING(t.d23, 19, 2) != 'NA' THEN SUBSTRING(t.d23, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d23, 19, 2) != 'NA' THEN (CASE WHEN t.D23_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D23_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d23, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +  (CASE WHEN SUBSTRING(t.d23, 28, 2) != 'NA' THEN SUBSTRING(t.d23, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d23, 28, 2) != 'NA' THEN (CASE WHEN t.D23_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D23_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d23, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end), (case when D24_Status like  '%NA%'     then '<br/>' + '24' + '(' +    (CASE WHEN SUBSTRING(t.d24, 19, 2) != 'NA' THEN SUBSTRING(t.d24, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d24, 19, 2) != 'NA' THEN (CASE WHEN t.D1_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D24_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d24, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +  (CASE WHEN SUBSTRING(t.d24, 28, 2) != 'NA' THEN SUBSTRING(t.d24, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d24, 28, 2) != 'NA' THEN (CASE WHEN t.D24_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D24_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d24, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D25_Status like  '%NA%'     then '<br/>' + '25' + '(' +  (CASE WHEN SUBSTRING(t.d25, 19, 2) != 'NA' THEN SUBSTRING(t.d25, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d25, 19, 2) != 'NA' THEN (CASE WHEN t.D25_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D25_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d25, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' + (CASE WHEN SUBSTRING(t.d25, 28, 2) != 'NA' THEN SUBSTRING(t.d25, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d25, 28, 2) != 'NA' THEN (CASE WHEN t.D25_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D25_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d25, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D26_Status like  '%NA%'     then '<br/>' + '26' + '(' +  (CASE WHEN SUBSTRING(t.d26, 19, 2) != 'NA' THEN SUBSTRING(t.d26, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d26, 19, 2) != 'NA' THEN (CASE WHEN t.D26_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D26_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d26, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +  (CASE WHEN SUBSTRING(t.d26, 28, 2) != 'NA' THEN SUBSTRING(t.d26, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d26, 28, 2) != 'NA' THEN (CASE WHEN t.D26_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D26_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d26, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D27_Status like  '%NA%'     then '<br/>' + '27' + '(' +    (CASE WHEN SUBSTRING(t.d27, 19, 2) != 'NA' THEN SUBSTRING(t.d27, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d27, 19, 2) != 'NA' THEN (CASE WHEN t.D27_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D27_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d27, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' + (CASE WHEN SUBSTRING(t.d27, 28, 2) != 'NA' THEN SUBSTRING(t.d27, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d27, 28, 2) != 'NA' THEN (CASE WHEN t.D27_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D27_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d27, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D28_Status like  '%NA%'     then '<br/>' + '28' + '(' +   (CASE WHEN SUBSTRING(t.d28, 19, 2) != 'NA' THEN SUBSTRING(t.d28, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d28, 19, 2) != 'NA' THEN (CASE WHEN t.D28_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D28_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d28, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +   (CASE WHEN SUBSTRING(t.d28, 28, 2) != 'NA' THEN SUBSTRING(t.d28, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d28, 28, 2) != 'NA' THEN (CASE WHEN t.D28_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D28_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d28, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D29_Status like  '%NA%'     then '<br/>' + '29' + '(' +   (CASE WHEN SUBSTRING(t.d29, 19, 2) != 'NA' THEN SUBSTRING(t.d29, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d29, 19, 2) != 'NA' THEN (CASE WHEN t.D29_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D29_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d29, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' + (CASE WHEN SUBSTRING(t.d29, 28, 2) != 'NA' THEN SUBSTRING(t.d29, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d29, 28, 2) != 'NA' THEN (CASE WHEN t.D29_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D29_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d29, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end),(case when D30_Status like  '%NA%'     then '<br/>' + '30' + '(' + (CASE WHEN SUBSTRING(t.d30, 19, 2) != 'NA' THEN SUBSTRING(t.d30, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d30, 19, 2) != 'NA' THEN (CASE WHEN t.D30_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D30_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d30, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +(CASE WHEN SUBSTRING(t.d30, 28, 2) != 'NA' THEN SUBSTRING(t.d30, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d30, 28, 2) != 'NA' THEN (CASE WHEN t.D30_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D30_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d30, 28, 2) = 'NA' THEN 'NA' ELSE '' END)  +')'  end),(case when D31_Status like  '%NA%'     then '<br/>' + '31' + '(' +    (CASE WHEN SUBSTRING(t.d31, 19, 2) != 'NA' THEN SUBSTRING(t.d31, 1, 5) ELSE '' END) +(CASE WHEN SUBSTRING(t.d31, 19, 2) != 'NA' THEN (CASE WHEN t.D1_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D31_meridian, 1, 2) ELSE '' END) ELSE '' END) + (CASE WHEN SUBSTRING(t.d31, 19, 2) = 'NA' THEN 'NA' ELSE '' END) + '-' +  (CASE WHEN SUBSTRING(t.d31, 28, 2) != 'NA' THEN SUBSTRING(t.d1, 7, 5) ELSE '' END) + (CASE WHEN SUBSTRING(t.d31, 28, 2) != 'NA' THEN (CASE WHEN t.D1_meridian IS NOT NULL THEN ' ' + SUBSTRING(t.D31_meridian, 4, 2) ELSE '' END) ELSE '' END) +(CASE WHEN SUBSTRING(t.d31, 28, 2) = 'NA' THEN 'NA' ELSE '' END) +')'  end)) as NAIntimeOutTime " +
   " from timesheet_Emp_Month t  join Employees e on t.UserId = e.EmpId join Designations des on e.CurrentDesignation=des.Id join branches b on e.Branch = b.id join Departments d on e.Department = d.id " +
   "join shift_master sm on sm.Id = e.Shift_Id " + cond + "and e.empid!=2 and sm.shifttype = (case when(select count(*) from designations ds where ds.name like 'Attender%' and ds.id = des.id) <> 0 then '1'  else '0' end )  and (D1_Status   like  '%LA%'  or   D2_Status  like  '%LA%'  or  D3_Status  like  '%LA%'  or  D4_Status  like  '%LA%'  or  D5_Status  like  '%LA%'  or  D6_Status  like  '%LA%'  or  D7_Status  like  '%LA%'  or  D8_Status  like  '%LA%'  or  D9_Status  like  '%LA%'  or  D10_Status  like  '%LA%'  or  D11_Status  like  '%LA%'  or  D12_Status  like  '%LA%'  or  D13_Status  like  '%LA%'  or  D14_Status  like  '%LA%'  or  D15_Status  like  '%LA%'  or  D16_Status  like  '%LA%'  or  D17_Status  like  '%LA%'  or  D18_Status  like  '%LA%'  or  D19_Status  like  '%LA%'  or  D20_Status  like  '%LA%'  or  D21_Status  like  '%LA%'  or  D22_Status  like  '%LA%'  or  D23_Status  like  '%LA%'  or  D24_Status  like  '%LA%'  or  D25_Status  like  '%LA%'  or  D26_Status  like  '%LA%'  or  D27_Status  like  '%LA%'  or  D28_Status  like  '%LA%'  or  D29_Status  like  '%LA%'  or  D30_Status  like  '%LA%'  or  D31_Status like  '%LA%')" +
   ...
   + " having (sum((case when D1_Status  like '%LA%'    then 1  else 0 end) +(case when D2_Status  like '%LA%'    then 1  else 0 end) +(case when D3_Status  like '%LA%'    then 1  else 0 end) +  (case when D4_Status  like '%LA%'    then 1  else 0 end) + (case when D5_Status  like '%LA%'    then 1  else 0 end) + (case when D6_Status  like '%LA%'    then 1  else 0 end) + (case when D7_Status  like '%LA%'    then 1  else 0 end) +  (case when D8_Status  like '%LA%'    then 1  else 0 end) + (case when D9_Status  like '%LA%'    then 1  else 0 end) + (case when D10_Status  like '%LA%'    then 1  else 0 end) + (case when D11_Status  like '%LA%'    then 1  else 0 end) + (case when D12_Status  like '%LA%'    then 1  else 0 end) + (case when D13_Status  like '%LA%'    then 1  else 0 end) + (case when D14_Status  like '%LA%'    then 1  else 0 end) + (case when D15_Status  like '%LA%'    then 1  else 0 end) + (case when D16_Status  like '%LA%'    then 1  else 0 end) + (case when D17_Status  like '%LA%'    then 1  else 0 end) + (case when D18_Status  like '%LA%'    then 1  else 0 end) + (case when D19_Status  like '%LA%'    then 1  else 0 end) + (case when D20_Status  like '%LA%'    then 1  else 0 end) + (case when D21_Status  like '%LA%'    then 1  else 0 end) + (case when D22_Status  like '%LA%'    then 1  else 0 end) + (case when D23_Status  like '%LA%'    then 1  else 0 end) + (case when D24_Status  like '%LA%'    then 1  else 0 end) + (case when D25_Status  like '%LA%'    then 1  else 0 end) + (case when D26_Status  like '%LA%'    then 1  else 0 end) + (case when D27_Status  like '%LA%'    then 1  else 0 end) + (case when D28_Status  like '%LA%'    then 1  else 0 end) + (case when D29_Status  like '%LA%'    then 1  else 0 end) + (case when D30_Status  like '%LA%'    then 1  else 0 end) + (case when D31_Status  like '%LA%'    then 1  else 0 end))>=3 " +
    " or sum((case when D1_Status  like '%NA%'    then 1  else 0 end) +(case when D2_Status  like '%NA%'    then 1  else 0 end) +(case when D3_Status  like '%NA%'    then 1  else 0 end) +(case when D4_Status  like '%NA%'    then 1  else 0 end) +(case when D5_Status  like '%NA%'    then 1  else 0 end) +(case when D6_Status  like '%NA%'    then 1  else 0 end) +(case when D7_Status  like '%NA%'    then 1  else 0 end) +(case when D8_Status  like '%NA%'    then 1  else 0 end) +(case when D9_Status  like '%NA%'    then 1  else 0 end) +(case when D10_Status  like '%NA%'    then 1  else 0 end) +(case when D11_Status  like '%NA%'    then 1  else 0 end) +(case when D12_Status  like '%NA%'    then 1  else 0 end) +(case when D13_Status  like '%NA%'    then 1  else 0 end) +(case when D14_Status  like '%NA%'    then 1  else 0 end) +(case when D15_Status  like '%NA%'    then 1  else 0 end) +(case when D16_Status  like '%NA%'    then 1  else 0 end) +(case when D17_Status  like '%NA%'    then 1  else 0 end) +(case when D18_Status  like '%NA%'    then 1  else 0 end) +(case when D19_Status  like '%NA%'    then 1  else 0 end) +(case when D20_Status  like '%NA%'    then 1  else 0 end) +(case when D21_Status  like '%NA%'    then 1  else 0 end) +(case when D22_Status  like '%NA%'    then 1  else 0 end) +(case when D23_Status  like '%NA%'    then 1  else 0 end) +(case when D24_Status  like '%NA%'    then 1  else 0 end) +(case when D25_Status  like '%NA%'    then 1  else 0 end) +(case when D26_Status  like '%NA%'    then 1  else 0 end) +(case when D27_Status  like '%NA%'    then 1  else 0 end) +(case when D28_Status  like '%NA%'    then 1  else 0 end) +(case when D29_Status  like '%NA%'    then 1  else 0 end) +(case when D30_Status  like '%NA%'    then 1  else 0 end) +(case when D31_Status  like '%NA%'    then 1  else 0 end)) >= 1)";
