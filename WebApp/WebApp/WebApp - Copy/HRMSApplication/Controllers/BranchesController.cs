        ...
        public JsonResult BranchViews(string Name)
        {
            ...
            if (string.IsNullOrEmpty(Name))
            {
                var branch = (from bank in Banks
                              ...
                              where (branchlist.IFSCCode != "TSHEADOFF" && branchlist.Name != "TSCAB-CTI")
                              select new
                              {
            ...
            else
            {
                var branch = (from branchlist in dbResult
                              where (branchlist.Name.ToLower().Contains(Name.ToLower()) && (branchlist.IFSCCode != "TSHEADOFF" && branchlist.Name != "TSCAB-CTI"))
                              select new
                              {
                                  branchlist.Id,
                                  branchlist.BankName,
        ...
        public JsonResult branchcountviews(string Name)
        {
            ...
            if (string.IsNullOrEmpty(Name))
            {
                var branch = (from brlist in branchcount
                              ...
                              where (branchlist.Name != "TSCAB-CTI")                       
                              select new
                              {
                                  brlist.Id,
                                  branchlist.Name,
