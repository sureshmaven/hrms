    ...
    public class RegisterController : Controller
    {
        ...
        public ActionResult ViewProfile(string username, string loginmode)
        {
            ...
            try
            {
                ...
                var items = Facade.EntitiesFacade.GetAllBranches().Where(a => a.IFSCCode != "TSHEADOFF" && a.Name != "TSCAB-CTI").Select(x => new Branches
                {
                    Id = x.Id,
                ...
                var items4b = Facade.EntitiesFacade.GetAllBranches().Where(a => a.IFSCCode != "TSHEADOFF" && a.Name != "TSCAB-CTI").Select(x => new Branches
                {
                    Id = x.Id,
                    Name = x.Name,
                });
                ...
                var selected4sb = (from sub in db.Employes
                                   where sub.Id == id
                                   select sub.Branch).FirstOrDefault();
                var items4sb = Facade.EntitiesFacade.GetAllBranches().Where(a => a.Id == selected2sd).Where(a => a.IFSCCode != "TSHEADOFF" && a.Name != "TSCAB-CTI").Select(x => new Branches
                {
                    Id = x.Id,
                    Name = x.Name,
                });
        ...
        public ActionResult InsertEmployees(Employees lmodel1)
        {
            ...
            try
            {
                ...
                var items5b = Facade.EntitiesFacade.GetAllBranches().Where(a => a.IFSCCode != "TSHEADOFF" && a.Name != "TSCAB-CTI").Select(x => new Branches
                {
                    Id = x.Id,
                    Name = x.Name.ToString()
                }).Distinct();
                ...
                var items5sb = Facade.EntitiesFacade.GetAllBranches().Where(a => a.IFSCCode != "TSHEADOFF" && a.Name != "TSCAB-CTI").Select(x => new Branches
                {
                    Id = x.Id,
                    Name = x.Name.ToString()
                }).Distinct();
