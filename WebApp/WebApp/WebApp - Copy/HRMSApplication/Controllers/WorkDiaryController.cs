...
namespace HRMSApplication.Controllers
{
    ...
    public class WorkDiaryController : Controller
    {
        ...
        public JsonResult CheckWorkDiary(string Date)
        {
            ...
            // if (count>0 && lcount1==0 && lname =="OD" )
            // {
            //     status = "countzero";
            //     return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            // }
            //else if (count > 0 && lcount1 == 0 && lname == "LTC")
            // {
            //     status = "countzero";
            //     return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            // }
            // else if (count > 0 && lcount1 == 0 && lname == "Leave")
            // {
            //     status = "countzero";
            //     return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            // }
            // else if (count == 0 && lcount1 == 0 && lname == "")
            // {
            //     status = "countzero";
            //     return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            // }
            // else if (count != 0 && lcount1 == 0 && lname == "")
            // {
            //     status = "false/" + lDate + "Work Dairy Cannot be Applied on Holidays.";
            //     return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            // }
            //else if (count != 0 && lname == "Leave")
            //{
            //    status = "false/" + lDate + lname + "Already applied in these dates.";
            //    return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            //}
            //else if (count != 0 && lname == "Leave")
            //{
            //    status = "false/" + lDate + "--Already Leave applied in these dates.";
            //    return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            //}
            //else if (count != 0 && lname == "LTC")
            //{
            //    status = "false/" + lDate + "--Already Leave applied in these dates.";
            //    return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            //}
            //else if (count == 0 && lname!="OD")
            //{
            //    status = "false/" + lDate + "--Already Workdiary applied in these dates.";
            //    return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            //}
            //else
            //{
            //    if(lname=="Leave" || lname=="LTC" || lname=="OD")
            //    {
            //        status = "false/" + lDate + " " + lname + " " + "Already applied in these dates.";
            //        return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            //    }
            ...
            //        return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            //    }
            //    status = "false/" + lDate + " Work Dairy Already applied in these dates.";
            //    return Json(new { message = status }, JsonRequestBehavior.AllowGet);
            //}
            return Json(new { message = status }, JsonRequestBehavior.AllowGet);
        }
