    ...
    public class AllReportsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            else
            {
                ...
                var dt = new SqlHelper().Get_Table_FromQry("Select [Id],[Name] from Branches Where Name!='OtherBranch' and Name!= 'TSCAB-CTI'");
        ...
        public ActionResult MissingTimesheet()
        {
            ...
            var dt = new SqlHelper().Get_Table_FromQry("Select [Id],[Name] from Branches Where Name!='OtherBranch' and Name!= 'TSCAB-CTI'");  // Where Name!='OtherBranch'
            var items = dt.AsEnumerable().Select(r => new Branches
            {
                Id = (Int32)(r["Id"]),
                Name = (string)(r["Name"] ?? "null")
...
{""data"": ""Status"", ""title"": ""Status"", ""autoWidth"": true }]";
        ...
        public ActionResult TimeSheetMonth(string branch, string fromdate, string todate, string empcode)
        {
            ...
            var dt = new SqlHelper().Get_Table_FromQry("Select [Id],concat((' '),(Name)) as Name from Branches where Name!='HeadOffice' and Name!='OtherBranch' and Name!= 'TSCAB-CTI'   UNION Select[Id], concat(('-'), (Name)) as Name from Departments d where Name!='OtherDepartment' and Active=1 order by Name");
            var items = dt.AsEnumerable().Select(r => new Branches
            {
                Id = (Int32)(r["Id"]),
                Name = (string)(r["Name"] ?? "null")
        ...
        public ActionResult CaAndSaOfEmployees(string branch)
        {
            ...
            var dt = new SqlHelper().Get_Table_FromQry("Select [Id],concat((' '),(Name)) as Name from Branches where Name!='HeadOffice' and Name!= 'TSCAB-CTI' and Name!='OtherBranch' UNION Select[Id], concat(('-'), (Name)) as Name from Departments d where Active=1 order by Name");
        ...
        public ActionResult Seniorty()
        {
            ...
            ViewBag.ReportTitle = "Seniorty List";
        ...
        public ActionResult StaffMaster()
        {
            ...
            string[] array = { "Emp Code","Emp Name", "Designation", "DOB", "DOJ", "Retirement Date", "Father Name", "Mother Name",
                                "Present Address","Permanent Address", "Mobile", "Category","Aadhar No", "Graduation", "PG", "Prof Qualifications", "Present Work Place","Personal Email","Official Email"};
        ...
        public ActionResult EarlyDepartsReport(string branch, string fromdate)
        {
            ...
            var dt = new SqlHelper().Get_Table_FromQry("Select [Id],concat((' '),(Name)) as Name from Branches where Name!='HeadOffice' and Name!= 'TSCAB-CTI' and Name!='OtherBranch' UNION Select[Id], concat(('-'), (Name)) as Name from Departments d where Name!='OtherDepartment' and Active=1 order by Name");
            var items = dt.AsEnumerable().Select(r => new Branches
            {
                Id = (Int32)(r["Id"]),
                Name = (string)(r["Name"] ?? "null")
...
{""title"": ""D31"",""data"": ""D31"",  ""autoWidth"": true }
        ...
        public ActionResult Covid19()
        {
            ...
            ViewBag.ReportColumns = @"[{""title"": """",""data"": ""col1"",  ""autoWidth"": true,""visible"": false },
            {""title"": """", ""data"": ""col2"", ""autoWidth"": true },
            {""title"": """",""data"": ""col3"", ""autoWidth"": true },
            {""title"": """",""data"": ""col4"",  ""autoWidth"": true },
            {""title"": """",""data"": ""col5"", ""autoWidth"": true },
            {""title"": """",""data"": ""col6"", ""autoWidth"": true },
            {""title"": """", ""data"": ""col7"", ""autoWidth"": true },
            {""title"": """",""data"": ""col8"", ""autoWidth"": true },
            {""title"": """",""data"": ""col9"",  ""autoWidth"": true },
            {""title"": """",""data"": ""col10"", ""autoWidth"": true },
            {""title"": """",""data"": ""col11"", ""autoWidth"": true },
            {""title"": """",""data"": ""col12"", ""autoWidth"": true },
            {""title"": """",""data"": ""col13"",  ""autoWidth"": true }]";
