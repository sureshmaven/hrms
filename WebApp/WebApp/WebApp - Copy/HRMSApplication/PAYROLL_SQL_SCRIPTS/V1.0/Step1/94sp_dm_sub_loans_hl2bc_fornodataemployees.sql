...
create PROCEDURE [dbo].[sp_dm_sub_loans_hl2bc_fornodataemployees] @emp_code integer,  @fmn integer
AS  
...
insert into #two_sub select distinct(LoanId) as loan_id from [TEST2].dbo.PoldLoanDet where LoanId='HL2BC';
