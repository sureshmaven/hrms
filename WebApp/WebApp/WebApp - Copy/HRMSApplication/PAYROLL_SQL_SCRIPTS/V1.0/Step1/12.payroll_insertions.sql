...
insert into new_num values ('pr_tax_option_emp_wise','id',(select max(id)+1 from pr_tax_option_emp_wise),0)
...
insert into pr_earn_field_master values (98,'Medical Aid','per_earn',1,218,NULL,'','');
insert into pr_earn_field_master values ((select max(id)+1 from pr_earn_field_master),'Shift Duty Allowance','pay_fields',1,(select max(trans_id)+1 from pr_earn_field_master),'','SP_SHFTDUTY','SP_SHFTDUTY')
insert into pr_earn_field_master values ((select max(id)+1 from pr_earn_field_master),'CEO Allowance','pay_fields',1,(select max(trans_id)+1 from pr_earn_field_master),'','CEOALLW','CEOALLW')
------------------------------- end-------------------------
...
insert into pr_deduction_field_master values ((select max(id)+1 from pr_deduction_field_master),'NON PRIORITY PERSONAL LOAN','EPD',1,(select max(trans_id)+1 from pr_deduction_field_master),null,'NPPL','NPPL');
...
insert into pr_allowance_field_master values(17,'Children Education Allowance','EMPA',1,17,'','','');
...
insert into pr_purpose_of_advance_master values (20,'PurchaseofSite',20,1,1,'REPAY','');
insert into pr_purpose_of_advance_master values (21,'MedicalExpenditure',21,1,1,'REPAY','');
insert into pr_purpose_of_advance_master values (22,'NR 90% Withdrawl',22,1,1,'REPAY','');
insert into pr_purpose_of_advance_master values (23,'Repayment of CCF Loans',23,1,1,'REPAY','');
...
insert into pr_emp_categories values(5,'Manager',0,125);--setting it to 0 as per the client as on 12/11/2020
...
insert into pr_emp_categories values(8,'Subordinate staff',1,128);
insert into pr_emp_categories values(9,'Manager scale 1',1,129);
insert into pr_emp_categories values(10,'Senior manager',1,130);
...
Insert into all_constants (app_type,functionality,constant,value,active,trans_id) values('payroll','IncomeTax','Section80EE_HL','200000',1,111);
...
insert into all_constants (app_type,functionality,constant,value,active,trans_id) values('payroll','IncomeTax','Section80EE',200000,1,111);
...
Insert into all_constants (app_type,functionality,constant,value,active,trans_id) values('payroll','IncomeTax','Section24(b)','200000',1,111);
...
Insert into all_constants (app_type,functionality,constant,value,active,trans_id) values('payroll','GenPayslip','CEOPercentage','0.15',1,111);
...
Insert into pr_incometax_bank_payment(id,fy,fm,trans_id) values(1,2020,'2020-04-01',121);
...
INSERT [dbo].[pr_payslip_customization] ([id], [m_id], [field_type], [cust_status], [active], [trans_id]) VALUES (64, 51, N'EMPSA', N'Yes', 1, 2003)
...
'per_ded',1,(select max(trans_id)+1 from pr_deduction_field_master),null,null,null);	
insert into pr_deduction_field_master values ((select max(id)+1 from pr_deduction_field_master),'LIC HFL INTEREST',
'per_ded',1,(select max(trans_id)+1 from pr_deduction_field_master),null,null,null);	
insert into pr_deduction_field_master values ((select max(id)+1 from pr_deduction_field_master),'HDFC HOUSING LOAN INTEREST',
'per_ded',1,(select max(trans_id)+1 from pr_deduction_field_master),null,null,null);	
insert into pr_deduction_field_master values ((select max(id)+1 from pr_deduction_field_master),'Housing Loan-IDBI',
...
'per_ded',1,(select max(trans_id)+1 from pr_deduction_field_master),null,null,null);	
insert into pr_deduction_field_master values ((select max(id)+1 from pr_deduction_field_master),'HLOAN INT InHouse',
'per_ded',1,(select max(trans_id)+1 from pr_deduction_field_master),null,null,null);	
...
Insert into pr_interface_vochers_codes (id,vocher_name,fas_gl_code1,fas_gl_code2,vocher_type) values
((select max(id)+1 from pr_interface_vochers_codes),'NON PRIORITY PERSONAL LOAN',0,0,'Deductions')