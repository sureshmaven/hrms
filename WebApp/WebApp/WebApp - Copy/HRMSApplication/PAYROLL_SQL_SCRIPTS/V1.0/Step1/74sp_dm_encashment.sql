...
where  p.paydate between '2019-04-01' and GETDATE() and p.pmonth>201903 and m.Empid = @employeecode and p.pmonth=@pmonth;
...
(select top 1  TotalExperience from employees where EmpId=@employeecode),3,'Encashment',2019,(select top 1  LeaveBalance from EmpLeaveBalance 
where empid=(select top 1  id from employees where empid=@employeecode) and LeaveTypeId=3 and year=2020),(select top 1 p.EncashDays from test2.dbo.PEncashment p join test2.dbo.PEMPMAST m on p.eid=m.eid where m.Empid=@employeecode and p.pmonth=@pmonth),(select Branch from employees where empid=@employeecode),
...
(select top 1  LeaveBalance from EmpLeaveBalance where empid=(select top 1  id from employees where empid=@employeecode) and LeaveTypeId=3 and year=2020),
