...
insert into #pfdetails values ((select '1' as id),(select 'Provident Fund' AS name),(select sum(dd_provident_fund) as amount  from pr_emp_payslip where fm>=@finstartyear and fm<=@currentmonth and emp_code = @empcode))
