...
@total_interest_installments_two int, @os_principal_amount_two int,@os_interest_amount_two float, @loanslno int
AS
...
@os_principal_amount_two, @os_interest_amount_two, 0 ,@os_principal_amount_two,0,0,1,@transidnew, @loanslno);
