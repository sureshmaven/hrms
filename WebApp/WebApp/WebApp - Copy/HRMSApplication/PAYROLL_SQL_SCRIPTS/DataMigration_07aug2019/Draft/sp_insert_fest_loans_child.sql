...
@principal_start_date,@principal_end_date,null,null,@total_principal_installments,0 ,@os_remaining_amount_paid,0  ,0 ,
@os_remaining_amount_paid,0,0,1,@transidnew, @loanslno);
