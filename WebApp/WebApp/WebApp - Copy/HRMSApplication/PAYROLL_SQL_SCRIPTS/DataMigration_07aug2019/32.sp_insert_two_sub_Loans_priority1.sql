CREATE PROCEDURE [dbo].[sp_insert_two_sub_Loans_priority1] @emp_code int, @loan_code varchar(20) ,@date_disburse date, @loan_amount int , @interest_rate float,
...
@total_principal_installments int ,@total_interest_installments int, @os_principal_amount int, @os_interest_amount float, @os_total_balace_amount float, 
@loanslno int
...
set @d_id=(select CurrentDesignation from employees where empid=@emp_code);
...
@os_principal_amount,@os_interest_amount  ,0 ,@os_total_balace_amount,
