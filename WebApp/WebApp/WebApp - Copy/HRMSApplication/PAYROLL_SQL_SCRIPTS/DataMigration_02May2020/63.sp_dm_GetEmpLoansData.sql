...
insert into dm_emp_mn_task
select empid,pmonth,concat(loanid,',') from test2.dbo.Poldloan po join test2.dbo.pempmast m on m.Eid=po.Eid 
...
and not empid in (select emp_code from dm_emp_mn_task)
