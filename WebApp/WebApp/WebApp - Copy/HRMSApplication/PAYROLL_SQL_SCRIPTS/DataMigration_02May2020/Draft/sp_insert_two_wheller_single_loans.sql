USE [pr_sep5_yadagiri]
GO
/****** Object:  StoredProcedure [dbo].[sp_insert_two_wheller_single_loans]    Script Date: 03-10-2019 15:33:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[sp_insert_two_wheller_single_loans] @emp_code nvarchar(20) , 
        @total_amount integer,
		@loan_code nvarchar(20),
		@method nvarchar(50), 
		@interest_rate nvarchar(20),  @total_installment nvarchar(20)  , 
		@remaining_installment nvarchar(20) , @principal_installment nvarchar(20) ,
		@interest_installment nvarchar(20) ,@completed_installment nvarchar(20), 
		@sanction_date date , 
...
@installment_start_date,@installment_end_date,@method,@interest_rate,@installment_amount,0,@total_recovered_amount,21,1,@transidnew,@fm,@fy,@loanslno);
