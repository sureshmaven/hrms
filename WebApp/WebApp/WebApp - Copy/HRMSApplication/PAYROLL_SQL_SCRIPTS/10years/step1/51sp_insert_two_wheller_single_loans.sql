...
create PROCEDURE [dbo].[sp_insert_two_wheller_single_loans] @emp_code nvarchar(20) , 
...
@installment_start_date,@installment_end_date,@method,@interest_rate,@installment_amount,0,@total_recovered_amount,21,@status,@transidnew,@fm,@fy,@loanslno);
