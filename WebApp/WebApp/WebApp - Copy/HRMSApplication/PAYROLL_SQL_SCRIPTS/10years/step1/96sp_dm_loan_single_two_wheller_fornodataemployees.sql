...
CREATE PROCEDURE [dbo].[sp_dm_loan_single_two_wheller_fornodataemployees] @emp_code integer, @fmn integer
AS
...
@installment_start_date=cast(l.SanDate as Date),
@installment_end_date = cast(l.SanDate as Date),
...
@principal_start_date_two=d.SanDate,
@principal_end_date_two=d.SanDate,
@interest_start_date_two=d.SanDate,
@interest_end_date_two=d.SanDate,
@total_principal_installments_two=84,
@total_interest_installments_two=32,
...
--join [TEST2].dbo.POldLoan l on d.loanslno=l.LoanSlNo
where
...
@priority = 0,
@principal_paid_amount= LoanRepaid
from [TEST2].dbo.POldLoandet l join [TEST2].dbo.PEMPMAST m on l.eid=m.eid
