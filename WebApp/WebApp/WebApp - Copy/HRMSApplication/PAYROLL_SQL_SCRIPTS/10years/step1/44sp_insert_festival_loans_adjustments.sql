...
values
(@idnew0,@loan_id, @adv_loans_child_id, @os_priciapl_open_amount, 
@total_recovered_amount_festival, 
@remaing_amount_adj_festival,  0,0,0, 0 , @completed_installment,  @installment_amount, @paid_date, @paid_date,
