...
update employee set department='MD Secretariat' where empid=5794;
update employees set 
...
update employee set department='ITSD' where empid=804;
...
update employee set department='TBD' where empid=994;
...
Branch_Value1=43,
Branch_Value_2=1
where EmpId in (5660,358,5780,377,359,340,555,976,265,364,176,356,790,376,457,287,5770,262,363,863,480,322,320,5794,5882);