                    ...
                    foreach (string empId in arrEmpId)
                    {
                        if (empId == " ")
                        {
                            ...
                            if (ds1.Tables[2].Rows.Count > 0)
                            {
                             ...
                             + ReportColHeader(0, "Name and Address of the Employer", "" + drEmp["name"].ToString() + ", TSCAB,Hyderabad"),
                                        column2 = "`",
                                        column3 = "`",
                                        column4 = "`",
                                    });
                            ...
                            if (ds.Tables[8].Rows.Count > 0)
                            {
                                ...
                                if (ds.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    lst.Add(new CommonReportModel
                                    {
                                        ...
                                        //column1 = "<span style = 'background-color:#ADD8E6' >NAME OF THE EMPLOYEE: " + drEmp["name"].ToString() + " " + "(" + (drEmp["emp_code"].ToString()) + ")" + "</span>",
                                        column1 = "<span style='color:#C8EAFB'>~</span>"
                                + ReportColHeader(0, "Name and Address of the Employer", "  " + "TSCAB,Hyderabad" + "  ," + " " + "  " + "  " + " " + "Emp Name:" + " " + drEmp["name"].ToString()),
                                        column2 = "`",
                                        column3 = "`",
                                        column4 = "`",
                                    });
